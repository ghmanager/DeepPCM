...
namespace Metamodel.Stoex
{
    ...
    public class FunctionLiteral : Atom, IFunctionLiteral, IModelElement
    {
        ...
        private void Parameters_FunctionLiteralCollectionChanging(object sender, NMF.Collections.ObjectModel.NotifyCollectionChangingEventArgs e)
        {
            this.OnCollectionChanging("Parameters_FunctionLiteral", e);
        }
