...
namespace Metamodel.Probfunction
{
    ...
    public class SamplePDF : ProbabilityDensityFunction, ISamplePDF, IModelElement
    {
        ...
        public virtual Nullable<double> Distance
        {
            ...
            set
            {
                if ((this._distance != value))
                {
                    ...
                    this.OnPropertyChanging("Distance", e);
        ...
        /// </summary>
        public event System.EventHandler<ValueChangedEventArgs> DistanceChanging;
        
        /// <summary>
        /// Gets fired when the Distance property changed its value
        /// </summary>
        public event System.EventHandler<ValueChangedEventArgs> DistanceChanged;
        ...
        {
            System.EventHandler<ValueChangedEventArgs> handler = this.DistanceChanging;
            if ((handler != null))
            {
        ...
        {
            System.EventHandler<ValueChangedEventArgs> handler = this.DistanceChanged;
            if ((handler != null))
            {
                handler.Invoke(this, eventArgs);
            }
