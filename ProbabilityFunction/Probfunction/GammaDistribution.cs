...
namespace Metamodel.Probfunction
{
    ...
    public class GammaDistribution : ContinuousPDF, IGammaDistribution, IModelElement
    {
        ...
        public virtual double Alpha
        {
            ...
            set
            {
                if ((this._alpha != value))
                {
                    ...
                    this.OnPropertyChanging("Alpha", e);
                    this._alpha = value;
        ...
        public virtual double Theta
        {
            ...
            set
            {
                if ((this._theta != value))
                {
                    ...
                    this.OnPropertyChanging("Theta", e);
                    this._theta = value;
        ...
        /// </summary>
        public event System.EventHandler<ValueChangedEventArgs> AlphaChanging;
        
        /// <summary>
        /// Gets fired when the Alpha property changed its value
        /// </summary>
        public event System.EventHandler<ValueChangedEventArgs> AlphaChanged;
        
        /// <summary>
        /// Gets fired before the Theta property changes its value
        /// </summary>
        public event System.EventHandler<ValueChangedEventArgs> ThetaChanging;
        
        /// <summary>
        /// Gets fired when the Theta property changed its value
        /// </summary>
        public event System.EventHandler<ValueChangedEventArgs> ThetaChanged;
        ...
        {
            System.EventHandler<ValueChangedEventArgs> handler = this.AlphaChanging;
            if ((handler != null))
            {
        ...
        {
            System.EventHandler<ValueChangedEventArgs> handler = this.AlphaChanged;
            if ((handler != null))
            {
                handler.Invoke(this, eventArgs);
            }
        ...
        {
            System.EventHandler<ValueChangedEventArgs> handler = this.ThetaChanging;
            if ((handler != null))
            {
                handler.Invoke(this, eventArgs);
            }
        ...
        {
            System.EventHandler<ValueChangedEventArgs> handler = this.ThetaChanged;
            if ((handler != null))
            {
                handler.Invoke(this, eventArgs);
            }
