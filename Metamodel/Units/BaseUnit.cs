...
namespace DeepPCM.Units
{
    ...
    public class BaseUnit : ModelElement, IBaseUnit, IModelElement
    {
        ...
        public new static NMF.Models.Meta.IClass ClassInstance
        {
            get
            {
                return NMF.Models.Repository.MetaRepository.Instance.ResolveClass("http://sdq.ipd.uka.de/Units/1.0#//BaseUnit/");
            }
        }
        ...
        {
            return ((IClass)(NMF.Models.Repository.MetaRepository.Instance.Resolve("http://sdq.ipd.uka.de/Units/1.0#//BaseUnit/")));
        }
