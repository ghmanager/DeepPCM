...
namespace DeepPCM.Deeppcm.Seff.Seff_performance
{
    ...
    public class InfrastructureCall : CallAction, IInfrastructureCall, IModelElement
    {
        ...
        /// </summary>
        public event EventHandler<ValueChangedEventArgs> RequiredInterface__InfrastructureCallChanged;
        ...
        {
            EventHandler<ValueChangedEventArgs> handler = this.RequiredInterface__InfrastructureCallChanged;
            if ((handler != null))
            {
                handler.Invoke(this, eventArgs);
            }
        ...
        /// <param name="sender">The object that sent this reset request</param>
        /// <param name="eventArgs">The event data for the reset event</param>
        private void OnResetRequiredInterface__InfrastructureCall(object sender, EventArgs eventArgs)
        {
