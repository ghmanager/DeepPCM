...
namespace DeepPCM.Deeppcm.Seff
{
    ...
    public class InternalAction : AbstractInternalControlFlowAction, IInternalAction, IModelElement
    {
        ...
        public new static NMF.Models.Meta.IClass ClassInstance
        {
            get
            {
                return NMF.Models.Repository.MetaRepository.Instance.ResolveClass("http://sdq.ipd.uka.de/PalladioComponentModel/5.0#//seff//InternalAction/");
            }
        }
        
        /// <summary>
        /// Forwards change notifications for the InternalFailureOccurrenceDescriptions__InternalAction property to the parent model element
        /// </summary>
        ...
        {
            return ((IClass)(NMF.Models.Repository.MetaRepository.Instance.Resolve("http://sdq.ipd.uka.de/PalladioComponentModel/5.0#//seff//InternalAction/")));
        }
