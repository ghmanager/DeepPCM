...
namespace DeepPCM.Deeppcm.Seff
{
    ...
    public class ExternalCallAction : AbstractAction, IExternalCallAction, IModelElement
    {
        ...
        /// </summary>
        public event EventHandler<ValueChangedEventArgs> Interface_ExternalServiceChanged;
        ...
        {
            EventHandler<ValueChangedEventArgs> handler = this.Interface_ExternalServiceChanged;
            if ((handler != null))
            {
                handler.Invoke(this, eventArgs);
            }
        ...
        /// <param name="sender">The object that sent this reset request</param>
        /// <param name="eventArgs">The event data for the reset event</param>
        private void OnResetInterface_ExternalService(object sender, EventArgs eventArgs)
        {
