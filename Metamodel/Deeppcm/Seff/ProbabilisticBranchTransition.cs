...
namespace DeepPCM.Deeppcm.Seff
{
    ...
    [ModelRepresentationClassAttribute("http://sdq.ipd.uka.de/PalladioComponentModel/5.0#//seff//ProbabilisticBranchTrans" +
        "ition/")]
    [DebuggerDisplayAttribute("ProbabilisticBranchTransition {Id}")]
    public class ProbabilisticBranchTransition : DeepPCM.Deeppcm.Seff.AbstractBranchTransition, IProbabilisticBranchTransition, IModelElement
    {
        ...
        public new static NMF.Models.Meta.IClass ClassInstance
        {
            get
            {
                return NMF.Models.Repository.MetaRepository.Instance.ResolveClass("http://sdq.ipd.uka.de/PalladioComponentModel/5.0#//seff//ProbabilisticBranchTrans" +
                        "ition/");
            }
        }
        ...
        {
            return ((IClass)(NMF.Models.Repository.MetaRepository.Instance.Resolve("http://sdq.ipd.uka.de/PalladioComponentModel/5.0#//seff//ProbabilisticBranchTrans" +
                    "ition/")));
        }
