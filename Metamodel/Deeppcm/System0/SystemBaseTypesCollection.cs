...
namespace DeepPCM.Deeppcm.System0
{
    ...
    /// <summary>
    /// The collection class to implement the refined BaseTypes reference for the System class
    /// </summary>
    public class SystemBaseTypesCollection : ICollectionExpression<IClass>, ICollection<IClass>, INotifyCollection<IClass>
    {
        
        private ISystem0 _parent;
        
        private static IClass[] _standardValues = new IClass[] {
                ((IClass)(NMF.Models.Repository.MetaRepository.Instance.Resolve("http://sdq.ipd.uka.de/PalladioComponentModel/5.0#//resourceenvironment//SystemDep" +
                        "loyment/")))};
        
        /// <summary>
        /// Creates a new instance
        /// </summary>
        public SystemBaseTypesCollection(ISystem0 parent)
        {
            this._parent = parent;
        }
        ...
        {
            if (SystemBaseTypesCollection._standardValues.Contains(item))
            {
                return true;
            }
            return false;
        ...
        {
            SystemBaseTypesCollection._standardValues.CopyTo(array, arrayIndex);
        ...
        {
            return SystemBaseTypesCollection._standardValues.Cast<IClass>().GetEnumerator();
        }
