...
namespace DeepPCM.Deeppcm.Resourcetype
{
    ...
    [ModelRepresentationClassAttribute("http://sdq.ipd.uka.de/PalladioComponentModel/5.0#//resourcetype//ResourceSignatur" +
        "e/")]
    [DebuggerDisplayAttribute("ResourceSignature {Id}")]
    public class ResourceSignature : DeepPCM.Deeppcm.Core.Entity.Entity, IResourceSignature, IModelElement
    {
        ...
        /// </summary>
        private DeepPCM.Deeppcm.Repository.IParameter _parameter__ResourceSignature;
        ...
        public virtual DeepPCM.Deeppcm.Repository.IParameter Parameter__ResourceSignature
        {
            get
            {
            ...
            set
            {
                ...
                {
                    DeepPCM.Deeppcm.Repository.IParameter old = this._parameter__ResourceSignature;
        ...
        public new static NMF.Models.Meta.IClass ClassInstance
        {
            get
            {
                return NMF.Models.Repository.MetaRepository.Instance.ResolveClass("http://sdq.ipd.uka.de/PalladioComponentModel/5.0#//resourcetype//ResourceSignatur" +
                        "e/");
            }
        }
        ...
        protected override void SetFeature(string feature, object value)
        {
            ...
            {
                this.Parameter__ResourceSignature = ((DeepPCM.Deeppcm.Repository.IParameter)(value));
                return;
            }
        ...
        {
            return ((IClass)(NMF.Models.Repository.MetaRepository.Instance.Resolve("http://sdq.ipd.uka.de/PalladioComponentModel/5.0#//resourcetype//ResourceSignatur" +
                    "e/")));
        }
        ...
        public class ResourceSignatureChildrenCollection : ReferenceCollection, ICollectionExpression<IModelElement>, ICollection<IModelElement>
        {
            ...
            public override void Add(IModelElement item)
            {
                if ((this._parent.Parameter__ResourceSignature == null))
                {
                    DeepPCM.Deeppcm.Repository.IParameter parameter__ResourceSignatureCasted = item.As<DeepPCM.Deeppcm.Repository.IParameter>();
        ...
        /// </summary>
        private sealed class Parameter__ResourceSignatureProxy : ModelPropertyChange<IResourceSignature, DeepPCM.Deeppcm.Repository.IParameter>
        {
