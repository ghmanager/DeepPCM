...
namespace DeepPCM.Deeppcm.Core.Composition
{
    ...
    public abstract class ComposedStructure : DeepPCM.Deeppcm.Core.Entity.Entity, IComposedStructure, IModelElement
    {
        ...
        public class ComposedStructureChildrenCollection : ReferenceCollection, ICollectionExpression<IModelElement>, ICollection<IModelElement>
        {
            ...
            {
                return Enumerable.Empty<IModelElement>().Concat(this._parent.AssemblyContexts__ComposedStructure).Concat(this._parent.EventChannel__ComposedStructure).Concat(this._parent.Connectors__ComposedStructure).GetEnumerator();
            }
        }
