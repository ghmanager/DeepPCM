...
namespace DeepPCM.Deeppcm.Core.Composition
{
    ...
    /// <summary>
    /// The default implementation of the InfrastructureProvider class
    /// </summary>
    ...
    [ModelRepresentationClassAttribute("http://sdq.ipd.uka.de/PalladioComponentModel/5.0#//core//composition//Infrastruct" +
        "ureProvider/")]
    [DebuggerDisplayAttribute("InfrastructureProvider {Name}")]
    public abstract class InfrastructureProvider : MetaElement, IInfrastructureProvider, IModelElement
    {
