...
namespace DeepPCM.Deeppcm.Core.Composition
{
    ...
    public abstract class AssemblyContext : MetaElement, IAssemblyContext, IModelElement
    {
        ...
        /// </summary>
        public abstract IRepositoryComponent GetRepositoryComponent();
        ...
        public class AssemblyContextReferencedElementsCollection : ReferenceCollection, ICollectionExpression<IModelElement>, ICollection<IModelElement>
        {
            ...
            public override IEnumerator<IModelElement> GetEnumerator()
            {
                return Enumerable.Empty<IModelElement>().Concat(this._parent.ComposedStructure__AssemblyContext).Concat(this._parent.ConfigParameterUsages__AssemblyContext).Concat(this._parent.DeclaringType).Concat(this._parent.Opposite).Concat(this._parent.Anchor).GetEnumerator();
            }
        }
