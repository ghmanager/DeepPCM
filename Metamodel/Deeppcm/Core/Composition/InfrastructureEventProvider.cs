...
namespace DeepPCM.Deeppcm.Core.Composition
{
    ...
    /// <summary>
    /// The default implementation of the InfrastructureEventProvider class
    /// </summary>
    ...
    [ModelRepresentationClassAttribute("http://sdq.ipd.uka.de/PalladioComponentModel/5.0#//core//composition//Infrastruct" +
        "ureEventProvider/")]
    [DebuggerDisplayAttribute("InfrastructureEventProvider {Name}")]
    public abstract class InfrastructureEventProvider : MetaElement, IInfrastructureEventProvider, IModelElement
    {
        
        /// <summary>
        /// The backing field for the ConfigParameterUsages__AssemblyContext property
        /// </summary>
        private DeepPCM.Deeppcm.Core.Composition.AssemblyContextConfigParameterUsages__AssemblyContextCollection _configParameterUsages__AssemblyContext;
        
        private static IReferenceType _ReferenceType = NMF.Models.Repository.MetaRepository.Instance.Resolve("http://sdq.ipd.uka.de/PalladioComponentModel/5.0#//resourceenvironment//ResourceC" +
                "ontainer/").As<IReferenceType>();
        ...
        public InfrastructureEventProvider()
        {
        ...
        /// </summary>
        public event EventHandler<ValueChangedEventArgs> ComposedStructure__AssemblyContextChanged;
        ...
        {
            EventHandler<ValueChangedEventArgs> handler = this.ComposedStructure__AssemblyContextChanged;
            if ((handler != null))
            {
        ...
        protected override void OnParentChanged(IModelElement newParent, IModelElement oldParent)
        {
            ...
            e = new ValueChangedEventArgs(oldDeclaringType, newDeclaringType);
        ...
        {
            return ((IRepositoryComponent)(NMF.Models.Repository.MetaRepository.Instance.Resolve("http://sdq.ipd.uka.de/PalladioComponentModel/5.0#//core//composition//Infrastruct" +
                    "ureEventProvider/")));
        }
