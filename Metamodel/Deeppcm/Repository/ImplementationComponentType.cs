...
namespace DeepPCM.Deeppcm.Repository
{
    ...
    [ModelRepresentationClassAttribute("http://sdq.ipd.uka.de/PalladioComponentModel/5.0#//repository//ImplementationComp" +
        "onentType/")]
    [DebuggerDisplayAttribute("ImplementationComponentType {Name}")]
    public abstract class ImplementationComponentType : MetaElement, IImplementationComponentType, IModelElement
    {
        ...
        public class ImplementationComponentTypeChildrenCollection : ReferenceCollection, ICollectionExpression<IModelElement>, ICollection<IModelElement>
        {
            ...
            {
                return Enumerable.Empty<IModelElement>().Concat(this._parent.ComponentParameterUsage_ImplementationComponentType).Concat(this._parent.References).Concat(this._parent.RequiredInterfaces).Concat(this._parent.ResourceRequiredRoles__ResourceInterfaceRequiringEntity).GetEnumerator();
            }
        }
