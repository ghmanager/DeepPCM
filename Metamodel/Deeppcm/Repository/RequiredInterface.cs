...
namespace DeepPCM.Deeppcm.Repository
{
    ...
    [ModelRepresentationClassAttribute("http://sdq.ipd.uka.de/PalladioComponentModel/5.0#//repository//RequiredInterface/" +
        "")]
    [DebuggerDisplayAttribute("RequiredInterface {Id}")]
    public abstract class RequiredInterface : MetaElement, IRequiredInterface, IModelElement
    {
        ...
        public new static NMF.Models.Meta.IClass ClassInstance
        {
            get
            {
                return NMF.Models.Repository.MetaRepository.Instance.ResolveClass("http://sdq.ipd.uka.de/PalladioComponentModel/5.0#//repository//RequiredInterface/" +
                        "");
            }
        }
        ...
        {
            return ((IClass)(NMF.Models.Repository.MetaRepository.Instance.Resolve("http://sdq.ipd.uka.de/PalladioComponentModel/5.0#//repository//RequiredInterface/" +
                    "")));
        }
        ...
        public class RequiredInterfaceReferencedElementsCollection : ReferenceCollection, ICollectionExpression<IModelElement>, ICollection<IModelElement>
        {
            ...
            {
                return Enumerable.Empty<IModelElement>().Concat(this._parent.Interface).Concat(this._parent.DeclaringType).Concat(this._parent.Opposite).Concat(this._parent.Refines).Concat(this._parent.Anchor).GetEnumerator();
            }
        }
