...
namespace DeepPCM.Deeppcm.Repository
{
    ...
    public class EventGroupBaseTypesCollection : ICollectionExpression<IClass>, ICollection<IClass>, INotifyCollection<IClass>
    {
        ...
        private IEventGroup _parent;
        
        private static IClass[] _standardValues = new IClass[] {
                ((IClass)(NMF.Models.Repository.MetaRepository.Instance.Resolve("http://sdq.ipd.uka.de/PalladioComponentModel/5.0#//core//composition//EventChanne" +
                        "l/")))};
        
        /// <summary>
        /// Creates a new instance
        /// </summary>
        public EventGroupBaseTypesCollection(IEventGroup parent)
        {
            this._parent = parent;
        }
