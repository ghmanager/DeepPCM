...
namespace DeepPCM.Deeppcm.Repository
{
    ...
    [ModelRepresentationClassAttribute("http://sdq.ipd.uka.de/PalladioComponentModel/5.0#//repository//RequiredOperationI" +
        "nterface/")]
    ...
    public class RequiredOperationInterface : MetaElement, IRequiredOperationInterface, IModelElement
    {
        ...
        public new static NMF.Models.Meta.IClass ClassInstance
        {
            get
            {
                return NMF.Models.Repository.MetaRepository.Instance.ResolveClass("http://sdq.ipd.uka.de/PalladioComponentModel/5.0#//repository//RequiredOperationI" +
                        "nterface/");
            }
        }
        ...
        /// </summary>
        public event EventHandler<ValueChangedEventArgs> OperationInterfaceChanged;
        ...
        {
            EventHandler<ValueChangedEventArgs> handler = this.OperationInterfaceChanged;
            if ((handler != null))
            {
        ...
        private void OnResetOperationInterface(object sender, EventArgs eventArgs)
        {
        ...
        {
            return ((IClass)(NMF.Models.Repository.MetaRepository.Instance.Resolve("http://sdq.ipd.uka.de/PalladioComponentModel/5.0#//repository//RequiredOperationI" +
                    "nterface/")));
        }
