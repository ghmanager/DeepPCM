...
namespace DeepPCM.Deeppcm.Repository
{
    ...
    /// <summary>
    /// The collection class to implement the refined BaseTypes reference for the OperationInterface class
    /// </summary>
    public class OperationInterfaceBaseTypesCollection : ICollectionExpression<IClass>, ICollection<IClass>, INotifyCollection<IClass>
    {
        
        private IOperationInterface _parent;
        
        private static IClass[] _standardValues = new IClass[] {
                ((IClass)(NMF.Models.Repository.MetaRepository.Instance.Resolve("http://sdq.ipd.uka.de/PalladioComponentModel/5.0#//core//composition//AssemblyCon" +
                        "text/")))};
        
        /// <summary>
        /// Creates a new instance
        /// </summary>
        public OperationInterfaceBaseTypesCollection(IOperationInterface parent)
        {
            this._parent = parent;
        }
        ...
        {
            if (OperationInterfaceBaseTypesCollection._standardValues.Contains(item))
            {
                return true;
            }
            return false;
        ...
        {
            OperationInterfaceBaseTypesCollection._standardValues.CopyTo(array, arrayIndex);
        ...
        {
            return OperationInterfaceBaseTypesCollection._standardValues.Cast<IClass>().GetEnumerator();
        }
