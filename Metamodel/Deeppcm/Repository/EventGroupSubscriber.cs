...
namespace DeepPCM.Deeppcm.Repository
{
    ...
    [ModelRepresentationClassAttribute("http://sdq.ipd.uka.de/PalladioComponentModel/5.0#//repository//EventGroupSubscrib" +
        "er/")]
    ...
    public class EventGroupSubscriber : MetaElement, IEventGroupSubscriber, IModelElement
    {
        ...
        public new static NMF.Models.Meta.IClass ClassInstance
        {
            get
            {
                return NMF.Models.Repository.MetaRepository.Instance.ResolveClass("http://sdq.ipd.uka.de/PalladioComponentModel/5.0#//repository//EventGroupSubscrib" +
                        "er/");
            }
        }
        ...
        /// </summary>
        public event EventHandler<ValueChangedEventArgs> EventGroupChanged;
        
        /// <summary>
        /// Gets fired when the FilterCondition__EventGroupSubscriber property changed its value
        /// </summary>
        public event EventHandler<ValueChangedEventArgs> FilterCondition__EventGroupSubscriberChanged;
        ...
        {
            EventHandler<ValueChangedEventArgs> handler = this.EventGroupChanged;
            if ((handler != null))
            {
        ...
        private void OnResetEventGroup(object sender, EventArgs eventArgs)
        {
        ...
        {
            EventHandler<ValueChangedEventArgs> handler = this.FilterCondition__EventGroupSubscriberChanged;
            if ((handler != null))
            {
                handler.Invoke(this, eventArgs);
            }
        ...
        /// <param name="sender">The object that sent this reset request</param>
        /// <param name="eventArgs">The event data for the reset event</param>
        private void OnResetFilterCondition__EventGroupSubscriber(object sender, EventArgs eventArgs)
        {
        ...
        {
            return ((IClass)(NMF.Models.Repository.MetaRepository.Instance.Resolve("http://sdq.ipd.uka.de/PalladioComponentModel/5.0#//repository//EventGroupSubscrib" +
                    "er/")));
        }
