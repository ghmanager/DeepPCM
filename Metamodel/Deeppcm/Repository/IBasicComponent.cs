...
namespace DeepPCM.Deeppcm.Repository
{
    ...
    public interface IBasicComponent : IModelElement, IImplementationComponentType
    {
        ...
        /// </summary>
        ICollectionExpression<IServiceEffectSpecification> ServiceEffectSpecifications__BasicComponent
        {
            get;
        }
        ...
        /// </summary>
        ICollectionExpression<IPassiveResource> PassiveResource_BasicComponent
        {
            get;
        }
    }
