...
namespace DeepPCM.Deeppcm.Reliability
{
    ...
    [ModelRepresentationClassAttribute("http://sdq.ipd.uka.de/PalladioComponentModel/5.0#//reliability//ExternalFailureOc" +
        "currenceDescription/")]
    public class ExternalFailureOccurrenceDescription : FailureOccurrenceDescription, IExternalFailureOccurrenceDescription, IModelElement
    {
        ...
        public new static NMF.Models.Meta.IClass ClassInstance
        {
            get
            {
                return NMF.Models.Repository.MetaRepository.Instance.ResolveClass("http://sdq.ipd.uka.de/PalladioComponentModel/5.0#//reliability//ExternalFailureOc" +
                        "currenceDescription/");
            }
        }
        ...
        {
            return ((IClass)(NMF.Models.Repository.MetaRepository.Instance.Resolve("http://sdq.ipd.uka.de/PalladioComponentModel/5.0#//reliability//ExternalFailureOc" +
                    "currenceDescription/")));
        }
