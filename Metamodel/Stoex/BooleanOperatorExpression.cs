...
namespace DeepPCM.Stoex
{
    ...
    public class BooleanOperatorExpression : BooleanExpression, IBooleanOperatorExpression, IModelElement
    {
        ...
        public new static NMF.Models.Meta.IClass ClassInstance
        {
            get
            {
                return NMF.Models.Repository.MetaRepository.Instance.ResolveClass("http://sdq.ipd.uka.de/StochasticExpressions/1.0#//BooleanOperatorExpression/");
            }
        }
        ...
        {
            return ((IClass)(NMF.Models.Repository.MetaRepository.Instance.Resolve("http://sdq.ipd.uka.de/StochasticExpressions/1.0#//BooleanOperatorExpression/")));
        }
