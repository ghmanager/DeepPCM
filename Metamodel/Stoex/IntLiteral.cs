...
namespace DeepPCM.Stoex
{
    ...
    public class IntLiteral : NumericLiteral, IIntLiteral, IModelElement
    {
        ...
        public new static NMF.Models.Meta.IClass ClassInstance
        {
            get
            {
                return NMF.Models.Repository.MetaRepository.Instance.ResolveClass("http://sdq.ipd.uka.de/StochasticExpressions/1.0#//IntLiteral/");
            }
        }
        ...
        {
            return ((IClass)(NMF.Models.Repository.MetaRepository.Instance.Resolve("http://sdq.ipd.uka.de/StochasticExpressions/1.0#//IntLiteral/")));
        }
