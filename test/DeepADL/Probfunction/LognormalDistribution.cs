...
namespace GeneratedCode.Probfunction
{
    ...
    public class LognormalDistribution : ContinuousPDF, ILognormalDistribution, IModelElement
    {
        ...
        public new static NMF.Models.Meta.IClass ClassInstance
        {
            get
            {
                return NMF.Models.Repository.MetaRepository.Instance.ResolveClass("http://sdq.ipd.uka.de/ProbFunction/1.0#//LognormalDistribution/");
            }
        }
        ...
        {
            return ((IClass)(NMF.Models.Repository.MetaRepository.Instance.Resolve("http://sdq.ipd.uka.de/ProbFunction/1.0#//LognormalDistribution/")));
        }
