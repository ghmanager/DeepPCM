...
namespace GeneratedCode.Pcm.Resourceenvironment
{
    ...
    [ModelRepresentationClassAttribute("http://sdq.ipd.uka.de/PalladioComponentModel/5.0#//resourceenvironment//LinkingRe" +
        "source/")]
    [DebuggerDisplayAttribute("LinkingResource {Id}")]
    public class LinkingResource : GeneratedCode.Pcm.Core.Entity.Entity, ILinkingResource, IModelElement
    {
        ...
        public new static NMF.Models.Meta.IClass ClassInstance
        {
            get
            {
                return NMF.Models.Repository.MetaRepository.Instance.ResolveClass("http://sdq.ipd.uka.de/PalladioComponentModel/5.0#//resourceenvironment//LinkingRe" +
                        "source/");
            }
        }
        ...
        /// <summary>
        /// Forwards change notifications for the ConnectedResourceContainers_LinkingResource property to the parent model element
        /// </summary>
        ...
        {
            return ((IClass)(NMF.Models.Repository.MetaRepository.Instance.Resolve("http://sdq.ipd.uka.de/PalladioComponentModel/5.0#//resourceenvironment//LinkingRe" +
                    "source/")));
        }
