...
namespace GeneratedCode.Pcm.Core.Composition
{
    ...
    [ModelRepresentationClassAttribute("http://sdq.ipd.uka.de/PalladioComponentModel/5.0#//core//composition//RequiredInf" +
        "rastructureDelegationConnector/")]
    [DebuggerDisplayAttribute("RequiredInfrastructureDelegationConnector {Id}")]
    public class RequiredInfrastructureDelegationConnector : DelegationConnector, IRequiredInfrastructureDelegationConnector, IModelElement
    {
        ...
        public virtual IInfrastructureRequiredRole InnerRequiredRole__RequiredInfrastructureDelegationConnector
        {
            get
            {
            ...
            set
            {
                if ((this._innerRequiredRole__RequiredInfrastructureDelegationConnector != value))
                {
                    ...
                    this.OnPropertyChanged("InnerRequiredRole__RequiredInfrastructureDelegationConnector", e);
                }
            }
        }
        ...
        [XmlAttributeAttribute(true)]
        public virtual IInfrastructureRequiredRole OuterRequiredRole__RequiredInfrastructureDelegationConnector
        {
            get
            {
            ...
            set
            {
                if ((this._outerRequiredRole__RequiredInfrastructureDelegationConnector != value))
                {
                    ...
                    this.OnPropertyChanged("OuterRequiredRole__RequiredInfrastructureDelegationConnector", e);
                }
            }
        }
        ...
        [XmlAttributeAttribute(true)]
        public virtual IAssemblyContext AssemblyContext__RequiredInfrastructureDelegationConnector
        {
            get
            {
            ...
            set
            {
                if ((this._assemblyContext__RequiredInfrastructureDelegationConnector != value))
                {
                    ...
                    this.OnPropertyChanged("AssemblyContext__RequiredInfrastructureDelegationConnector", e);
                }
            }
        }
        ...
        public new static NMF.Models.Meta.IClass ClassInstance
        {
            get
            {
                return NMF.Models.Repository.MetaRepository.Instance.ResolveClass("http://sdq.ipd.uka.de/PalladioComponentModel/5.0#//core//composition//RequiredInf" +
                        "rastructureDelegationConnector/");
            }
        }
        ...
        {
            return ((IClass)(NMF.Models.Repository.MetaRepository.Instance.Resolve("http://sdq.ipd.uka.de/PalladioComponentModel/5.0#//core//composition//RequiredInf" +
                    "rastructureDelegationConnector/")));
        }
        ...
        private sealed class InnerRequiredRole__RequiredInfrastructureDelegationConnectorProxy : ModelPropertyChange<IRequiredInfrastructureDelegationConnector, IInfrastructureRequiredRole>
        {
            ...
            {
                this.ModelElement.InnerRequiredRole__RequiredInfrastructureDelegationConnectorChanged += handler;
            }
        ...
        private sealed class OuterRequiredRole__RequiredInfrastructureDelegationConnectorProxy : ModelPropertyChange<IRequiredInfrastructureDelegationConnector, IInfrastructureRequiredRole>
        {
            ...
            protected override void RegisterChangeEventHandler(System.EventHandler<NMF.Expressions.ValueChangedEventArgs> handler)
            {
                this.ModelElement.OuterRequiredRole__RequiredInfrastructureDelegationConnectorChanged += handler;
            }
        ...
        private sealed class AssemblyContext__RequiredInfrastructureDelegationConnectorProxy : ModelPropertyChange<IRequiredInfrastructureDelegationConnector, IAssemblyContext>
        {
            ...
            protected override void RegisterChangeEventHandler(System.EventHandler<NMF.Expressions.ValueChangedEventArgs> handler)
            {
                this.ModelElement.AssemblyContext__RequiredInfrastructureDelegationConnectorChanged += handler;
            }
