...
namespace GeneratedCode.Pcm.Core.Entity
{
    ...
    [ModelRepresentationClassAttribute("http://sdq.ipd.uka.de/PalladioComponentModel/5.0#//core//entity//ComposedProvidin" +
        "gRequiringEntity/")]
    [DebuggerDisplayAttribute("ComposedProvidingRequiringEntity {Id}")]
    public abstract class ComposedProvidingRequiringEntity : ComposedStructure, IComposedProvidingRequiringEntity, IModelElement
    {
        ...
        public new static NMF.Models.Meta.IClass ClassInstance
        {
            get
            {
                return NMF.Models.Repository.MetaRepository.Instance.ResolveClass("http://sdq.ipd.uka.de/PalladioComponentModel/5.0#//core//entity//ComposedProvidin" +
                        "gRequiringEntity/");
            }
        }
        ...
        {
            return ((IClass)(NMF.Models.Repository.MetaRepository.Instance.Resolve("http://sdq.ipd.uka.de/PalladioComponentModel/5.0#//core//entity//ComposedProvidin" +
                    "gRequiringEntity/")));
        }
    }
}
