...
namespace GeneratedCode.Pcm.Usagemodel
{
    ...
    public class EntryLevelSystemCall : AbstractUserAction, IEntryLevelSystemCall, IModelElement
    {
        ...
        [XmlAttributeAttribute(true)]
        public virtual IOperationProvidedRole ProvidedRole_EntryLevelSystemCall
        {
            get
            {
            ...
            set
            {
                if ((this._providedRole_EntryLevelSystemCall != value))
                {
                    ...
                    this.OnPropertyChanged("ProvidedRole_EntryLevelSystemCall", e);
                }
            }
        }
        ...
        private sealed class ProvidedRole_EntryLevelSystemCallProxy : ModelPropertyChange<IEntryLevelSystemCall, IOperationProvidedRole>
        {
            ...
            protected override void RegisterChangeEventHandler(System.EventHandler<NMF.Expressions.ValueChangedEventArgs> handler)
            {
                this.ModelElement.ProvidedRole_EntryLevelSystemCallChanged += handler;
            }
