...
namespace GeneratedCode.Pcm.Resourcetype
{
    ...
    public class ResourceSignature : GeneratedCode.Pcm.Core.Entity.Entity, IResourceSignature, IModelElement
    {
        ...
        /// </summary>
        private IParameter _parameter__ResourceSignature;
        ...
        public virtual IParameter Parameter__ResourceSignature
        {
            get
            {
            ...
            set
            {
                ...
                {
                    IParameter old = this._parameter__ResourceSignature;
        ...
        protected override void SetFeature(string feature, object value)
        {
            ...
            {
                this.Parameter__ResourceSignature = ((IParameter)(value));
                return;
            }
        ...
        public class ResourceSignatureChildrenCollection : ReferenceCollection, ICollectionExpression<IModelElement>, ICollection<IModelElement>
        {
            ...
            public override void Add(IModelElement item)
            {
                if ((this._parent.Parameter__ResourceSignature == null))
                {
                    IParameter parameter__ResourceSignatureCasted = item.As<IParameter>();
        ...
        /// </summary>
        private sealed class Parameter__ResourceSignatureProxy : ModelPropertyChange<IResourceSignature, IParameter>
        {
