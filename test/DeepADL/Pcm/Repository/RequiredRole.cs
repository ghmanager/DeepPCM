...
namespace GeneratedCode.Pcm.Repository
{
    ...
    public abstract class RequiredRole : Role, IRequiredRole, IModelElement
    {
        ...
        public virtual IInterfaceRequiringEntity RequiringEntity_RequiredRole
        {
            get
            {
        ...
        public new static NMF.Models.Meta.IClass ClassInstance
        {
            get
            {
                return NMF.Models.Repository.MetaRepository.Instance.ResolveClass("http://sdq.ipd.uka.de/PalladioComponentModel/5.0#//repository//RequiredRole/");
            }
        }
        ...
        protected override void OnParentChanged(IModelElement newParent, IModelElement oldParent)
        {
            ...
            this.OnPropertyChanged("RequiringEntity_RequiredRole", e);
        }
        ...
        {
            return ((IClass)(NMF.Models.Repository.MetaRepository.Instance.Resolve("http://sdq.ipd.uka.de/PalladioComponentModel/5.0#//repository//RequiredRole/")));
        }
        ...
        private sealed class RequiringEntity_RequiredRoleProxy : ModelPropertyChange<IRequiredRole, IInterfaceRequiringEntity>
        {
            ...
            {
                this.ModelElement.RequiringEntity_RequiredRoleChanged += handler;
            }
