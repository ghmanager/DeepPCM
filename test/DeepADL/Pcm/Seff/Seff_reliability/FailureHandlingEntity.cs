...
namespace GeneratedCode.Pcm.Seff.Seff_reliability
{
    ...
    [ModelRepresentationClassAttribute("http://sdq.ipd.uka.de/PalladioComponentModel/5.0#//seff//seff_reliability//Failur" +
        "eHandlingEntity/")]
    [DebuggerDisplayAttribute("FailureHandlingEntity {Id}")]
    public abstract class FailureHandlingEntity : GeneratedCode.Pcm.Core.Entity.Entity, IFailureHandlingEntity, IModelElement
    {
        ...
        public new static NMF.Models.Meta.IClass ClassInstance
        {
            get
            {
                return NMF.Models.Repository.MetaRepository.Instance.ResolveClass("http://sdq.ipd.uka.de/PalladioComponentModel/5.0#//seff//seff_reliability//Failur" +
                        "eHandlingEntity/");
            }
        }
        ...
        {
            return ((IClass)(NMF.Models.Repository.MetaRepository.Instance.Resolve("http://sdq.ipd.uka.de/PalladioComponentModel/5.0#//seff//seff_reliability//Failur" +
                    "eHandlingEntity/")));
        }
