...
namespace Metamodel.Stoex
{
    ...
    public class Parenthesis : Atom, IParenthesis, IModelElement
    {
        ...
        public virtual IExpression InnerExpression
        {
            get
            {
            ...
            set
            {
                if ((this._innerExpression != value))
                {
                    ...
                    this.OnPropertyChanging("InnerExpression", e);
                    ...
                    this.OnPropertyChanged("InnerExpression", e);
                }
            }
        }
        ...
        /// </summary>
        public event System.EventHandler<ValueChangedEventArgs> InnerExpressionChanging;
        
        /// <summary>
        /// Gets fired when the InnerExpression property changed its value
        /// </summary>
        public event System.EventHandler<ValueChangedEventArgs> InnerExpressionChanged;
        ...
        {
            System.EventHandler<ValueChangedEventArgs> handler = this.InnerExpressionChanging;
            if ((handler != null))
            {
        ...
        {
            System.EventHandler<ValueChangedEventArgs> handler = this.InnerExpressionChanged;
            if ((handler != null))
            {
                handler.Invoke(this, eventArgs);
            }
        ...
        private void OnResetInnerExpression(object sender, System.EventArgs eventArgs)
        {
        ...
        private sealed class InnerExpressionProxy : ModelPropertyChange<IParenthesis, IExpression>
        {
            ...
            {
                this.ModelElement.InnerExpressionChanged += handler;
            }
