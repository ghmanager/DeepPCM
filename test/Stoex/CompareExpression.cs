...
namespace Metamodel.Stoex
{
    ...
    public class CompareExpression : Comparison, ICompareExpression, IModelElement
    {
        ...
        public virtual CompareOperations Operation
        {
            get
            {
