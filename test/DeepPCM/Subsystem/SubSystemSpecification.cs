...
namespace Metamodel.DeepPCM.Subsystem
{
    ...
    /// <summary>
    /// The default implementation of the SubSystemSpecification class
    /// </summary>
    [XmlNamespaceAttribute("http://github.com/ghmanager/DeepPCM/SubSystem/1.0")]
    [XmlNamespacePrefixAttribute("subsystem")]
    [ModelRepresentationClassAttribute("http://github.com/ghmanager/DeepPCM/1.0#//subsystem//SubSystemSpecification/")]
    [DebuggerDisplayAttribute("SubSystemSpecification {Name}")]
    public class SubSystemSpecification : NMF.Models.Meta.Type, ISubSystemSpecification, IModelElement
    {
        ...
        ICollectionExpression<IClass> IClass.BaseTypes
        {
            get
            {
                return new SubSystemSpecificationBaseTypesCollection(this);
            }
        }
        ...
        public new static IClass ClassInstance
        {
            get
            {
                ...
                {
                    _classInstance = ((IClass)(MetaRepository.Instance.Resolve("http://github.com/ghmanager/DeepPCM/1.0#//subsystem//SubSystemSpecification/")));
                }
