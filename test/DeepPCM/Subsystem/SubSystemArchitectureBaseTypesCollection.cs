...
namespace Metamodel.DeepPCM.Subsystem
{
    ...
    /// <summary>
    /// The collection class to implement the refined BaseTypes reference for the SubSystemArchitecture class
    /// </summary>
    public class SubSystemArchitectureBaseTypesCollection : ICollectionExpression<IClass>, ICollection<IClass>, INotifyCollection<IClass>
    {
        
        private ISubSystemArchitecture _parent;
        ...
        /// </summary>
        public SubSystemArchitectureBaseTypesCollection(ISubSystemArchitecture parent)
        {
            this._parent = parent;
        }
        ...
        {
            if (SubSystemArchitectureBaseTypesCollection._standardValues.Contains(item))
            {
                return true;
            }
            return false;
        ...
        {
            SubSystemArchitectureBaseTypesCollection._standardValues.CopyTo(array, arrayIndex);
        ...
        {
            return SubSystemArchitectureBaseTypesCollection._standardValues.Cast<IClass>().GetEnumerator();
        }
