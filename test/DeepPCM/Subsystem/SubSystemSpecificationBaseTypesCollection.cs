...
namespace Metamodel.DeepPCM.Subsystem
{
    ...
    /// <summary>
    /// The collection class to implement the refined BaseTypes reference for the SubSystemSpecification class
    /// </summary>
    public class SubSystemSpecificationBaseTypesCollection : ICollectionExpression<IClass>, ICollection<IClass>, INotifyCollection<IClass>
    {
        
        private ISubSystemSpecification _parent;
        
        private static IClass[] _standardValues = new IClass[] {
                ((IClass)(NMF.Models.Repository.MetaRepository.Instance.Resolve("http://github.com/ghmanager/DeepPCM/1.0#//subsystem//SubSystemArchitecture/")))};
        
        /// <summary>
        /// Creates a new instance
        /// </summary>
        public SubSystemSpecificationBaseTypesCollection(ISubSystemSpecification parent)
        {
            this._parent = parent;
        ...
        {
            if (SubSystemSpecificationBaseTypesCollection._standardValues.Contains(item))
            {
                return true;
            }
        ...
        {
            SubSystemSpecificationBaseTypesCollection._standardValues.CopyTo(array, arrayIndex);
        ...
        {
            return SubSystemSpecificationBaseTypesCollection._standardValues.Cast<IClass>().Concat(this._parent.ProvidedInterfaces).GetEnumerator();
        }
