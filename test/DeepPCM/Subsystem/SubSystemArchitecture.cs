...
namespace Metamodel.DeepPCM.Subsystem
{
    
    
    /// <summary>
    /// The default implementation of the SubSystemArchitecture class
    /// </summary>
    [XmlNamespaceAttribute("http://github.com/ghmanager/DeepPCM/SubSystem/1.0")]
    [XmlNamespacePrefixAttribute("subsystem")]
    [ModelRepresentationClassAttribute("http://github.com/ghmanager/DeepPCM/1.0#//subsystem//SubSystemArchitecture/")]
    [DebuggerDisplayAttribute("SubSystemArchitecture {Id}")]
    public class SubSystemArchitecture : NMF.Models.Meta.Type, ISubSystemArchitecture, IModelElement
    {
        ...
        ICollectionExpression<IClass> IClass.BaseTypes
        {
            get
            {
                return new SubSystemArchitectureBaseTypesCollection(this);
            }
        }
        ...
        public new static IClass ClassInstance
        {
            get
            {
                ...
                {
                    _classInstance = ((IClass)(MetaRepository.Instance.Resolve("http://github.com/ghmanager/DeepPCM/1.0#//subsystem//SubSystemArchitecture/")));
                }
