...
namespace Metamodel.DeepPCM.Repository
{
    ...
    /// <summary>
    /// The collection class to implement the refined References reference for the CompositeComponent class
    /// </summary>
    public class CompositeComponentReferencesCollection : ICollectionExpression<IReference>, ICollection<IReference>, INotifyCollection<IReference>
    {
        ...
        /// </summary>
        public CompositeComponentReferencesCollection(ICompositeComponent parent)
        {
            this._parent = parent;
