...
namespace Metamodel.DeepPCM.Repository
{
    ...
    public class RepositoryTypesCollection : ICollectionExpression<IType>, ICollection<IType>, INotifyCollection<IType>
    {
        ...
        {
            return Enumerable.Empty<IType>().Concat(this._parent.Components__Repository).Concat(this._parent.Interfaces__Repository).Concat(this._parent.EventChannel__Repository).Concat(this._parent.Delegate__Repository).Concat(this._parent.SystemSpecifications).GetEnumerator();
        }
