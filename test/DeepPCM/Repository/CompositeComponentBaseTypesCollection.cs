...
namespace Metamodel.DeepPCM.Repository
{
    ...
    /// <summary>
    /// The collection class to implement the refined BaseTypes reference for the CompositeComponent class
    /// </summary>
    public class CompositeComponentBaseTypesCollection : ICollectionExpression<IClass>, ICollection<IClass>, INotifyCollection<IClass>
    {
        
        private ICompositeComponent _parent;
        ...
        /// </summary>
        public CompositeComponentBaseTypesCollection(ICompositeComponent parent)
        {
            this._parent = parent;
        ...
        {
            if (CompositeComponentBaseTypesCollection._standardValues.Contains(item))
            {
                return true;
            }
        ...
        {
            CompositeComponentBaseTypesCollection._standardValues.CopyTo(array, arrayIndex);
        ...
        {
            return CompositeComponentBaseTypesCollection._standardValues.Cast<IClass>().Concat(this._parent.ProvidedInterfaces).GetEnumerator();
        }
