...
namespace Metamodel.DeepPCM.Repository
{
    ...
    public class RepositoryDelegate__RepositoryCollection : ObservableOppositeList<IRepository, IDelegate>
    {
        
        public RepositoryDelegate__RepositoryCollection(IRepository parent) : 
                base(parent)
        {
        }
        ...
        protected override void SetOpposite(IDelegate item, IRepository parent)
        {
            if ((parent != null))
            {
                ...
                item.Repository__Delegate = parent;
            }
            else
            {
                item.Deleted -= this.OnItemDeleted;
                if ((item.Repository__Delegate == this.Parent))
                {
                    item.Repository__Delegate = parent;
                }
            }
