...
namespace Metamodel.DeepPCM.Seff
{
    ...
    [ModelRepresentationClassAttribute("http://github.com/ghmanager/DeepPCM/1.0#//seff//LoopAction/")]
    ...
    public class LoopAction : AbstractLoopAction, ILoopAction, IModelElement
    {
        ...
        public virtual IPCMRandomVariable IterationCount_LoopAction
        {
            ...
            set
            {
                if ((this._iterationCount_LoopAction != value))
                {
                    ...
                    this.OnPropertyChanging("IterationCount_LoopAction", e);
        ...
        public new static IClass ClassInstance
        {
            get
            {
                ...
                {
                    _classInstance = ((IClass)(MetaRepository.Instance.Resolve("http://github.com/ghmanager/DeepPCM/1.0#//seff//LoopAction/")));
                }
        ...
        /// </summary>
        public event System.EventHandler<ValueChangedEventArgs> IterationCount_LoopActionChanging;
        
        /// <summary>
        /// Gets fired when the IterationCount_LoopAction property changed its value
        /// </summary>
        public event System.EventHandler<ValueChangedEventArgs> IterationCount_LoopActionChanged;
        ...
        {
            System.EventHandler<ValueChangedEventArgs> handler = this.IterationCount_LoopActionChanging;
            if ((handler != null))
            {
        ...
        {
            System.EventHandler<ValueChangedEventArgs> handler = this.IterationCount_LoopActionChanged;
            if ((handler != null))
            {
                handler.Invoke(this, eventArgs);
            }
        ...
        private void OnResetIterationCount_LoopAction(object sender, System.EventArgs eventArgs)
        {
