...
namespace Metamodel.DeepPCM.Seff
{
    ...
    [ModelRepresentationClassAttribute("http://github.com/ghmanager/DeepPCM/1.0#//seff//ForkAction/")]
    ...
    public class ForkAction : AbstractInternalControlFlowAction, IForkAction, IModelElement
    {
        ...
        public virtual ISynchronisationPoint SynchronisingBehaviours_ForkAction
        {
            ...
            set
            {
                if ((this._synchronisingBehaviours_ForkAction != value))
                {
                    ...
                    this.OnPropertyChanging("SynchronisingBehaviours_ForkAction", e);
        ...
        public new static IClass ClassInstance
        {
            get
            {
                ...
                {
                    _classInstance = ((IClass)(MetaRepository.Instance.Resolve("http://github.com/ghmanager/DeepPCM/1.0#//seff//ForkAction/")));
                }
        ...
        /// </summary>
        public event System.EventHandler<ValueChangedEventArgs> SynchronisingBehaviours_ForkActionChanging;
        
        /// <summary>
        /// Gets fired when the SynchronisingBehaviours_ForkAction property changed its value
        /// </summary>
        public event System.EventHandler<ValueChangedEventArgs> SynchronisingBehaviours_ForkActionChanged;
        ...
        private void AsynchronousForkedBehaviours_ForkActionCollectionChanging(object sender, NMF.Collections.ObjectModel.NotifyCollectionChangingEventArgs e)
        {
            this.OnCollectionChanging("AsynchronousForkedBehaviours_ForkAction", e);
        }
        ...
        {
            System.EventHandler<ValueChangedEventArgs> handler = this.SynchronisingBehaviours_ForkActionChanging;
            if ((handler != null))
            {
        ...
        {
            System.EventHandler<ValueChangedEventArgs> handler = this.SynchronisingBehaviours_ForkActionChanged;
            if ((handler != null))
            {
                handler.Invoke(this, eventArgs);
            }
        ...
        private void OnResetSynchronisingBehaviours_ForkAction(object sender, System.EventArgs eventArgs)
        {
