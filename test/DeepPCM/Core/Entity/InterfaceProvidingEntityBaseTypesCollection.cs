...
namespace Metamodel.DeepPCM.Core.Entity
{
    ...
    /// <summary>
    /// The collection class to implement the refined BaseTypes reference for the InterfaceProvidingEntity class
    /// </summary>
    public class InterfaceProvidingEntityBaseTypesCollection : ICollectionExpression<IClass>, ICollection<IClass>, INotifyCollection<IClass>
    {
        
        private IInterfaceProvidingEntity _parent;
        
        /// <summary>
        /// Creates a new instance
        /// </summary>
        public InterfaceProvidingEntityBaseTypesCollection(IInterfaceProvidingEntity parent)
        {
            this._parent = parent;
        ...
        {
            return Enumerable.Empty<IClass>().Concat(this._parent.ProvidedInterfaces).GetEnumerator();
        }
