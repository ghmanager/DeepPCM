...
namespace Metamodel.DeepPCM.Core.Composition
{
    ...
    public interface IConnector : IModelElement, IEntity
    {
        ...
        /// </summary>
        event System.EventHandler<ValueChangedEventArgs> ParentStructure__ConnectorChanging;
        
        /// <summary>
        /// Gets fired when the ParentStructure__Connector property changed its value
        /// </summary>
        event System.EventHandler<ValueChangedEventArgs> ParentStructure__ConnectorChanged;
    }
}
