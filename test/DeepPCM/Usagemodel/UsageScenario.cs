...
namespace Metamodel.DeepPCM.Usagemodel
{
    ...
    [ModelRepresentationClassAttribute("http://github.com/ghmanager/DeepPCM/1.0#//usagemodel//UsageScenario/")]
    [DebuggerDisplayAttribute("UsageScenario {Id}")]
    public class UsageScenario : Metamodel.DeepPCM.Core.Entity.Entity, IUsageScenario, IModelElement
    {
        ...
        public virtual IScenarioBehaviour ScenarioBehaviour_UsageScenario
        {
            ...
            set
            {
                if ((this._scenarioBehaviour_UsageScenario != value))
                {
                    ...
                    this.OnPropertyChanging("ScenarioBehaviour_UsageScenario", e);
        ...
        public virtual IWorkload Workload_UsageScenario
        {
            ...
            set
            {
                if ((this._workload_UsageScenario != value))
                {
                    ...
                    this.OnPropertyChanging("Workload_UsageScenario", e);
        ...
        public new static IClass ClassInstance
        {
            get
            {
                ...
                {
                    _classInstance = ((IClass)(MetaRepository.Instance.Resolve("http://github.com/ghmanager/DeepPCM/1.0#//usagemodel//UsageScenario/")));
                }
        ...
        /// </summary>
        public event System.EventHandler<ValueChangedEventArgs> UsageModel_UsageScenarioChanging;
        
        /// <summary>
        /// Gets fired when the UsageModel_UsageScenario property changed its value
        /// </summary>
        public event System.EventHandler<ValueChangedEventArgs> UsageModel_UsageScenarioChanged;
        
        /// <summary>
        /// Gets fired before the ScenarioBehaviour_UsageScenario property changes its value
        /// </summary>
        public event System.EventHandler<ValueChangedEventArgs> ScenarioBehaviour_UsageScenarioChanging;
        
        /// <summary>
        /// Gets fired when the ScenarioBehaviour_UsageScenario property changed its value
        /// </summary>
        public event System.EventHandler<ValueChangedEventArgs> ScenarioBehaviour_UsageScenarioChanged;
        
        /// <summary>
        /// Gets fired before the Workload_UsageScenario property changes its value
        /// </summary>
        public event System.EventHandler<ValueChangedEventArgs> Workload_UsageScenarioChanging;
        
        /// <summary>
        /// Gets fired when the Workload_UsageScenario property changed its value
        /// </summary>
        public event System.EventHandler<ValueChangedEventArgs> Workload_UsageScenarioChanged;
        ...
        {
            System.EventHandler<ValueChangedEventArgs> handler = this.UsageModel_UsageScenarioChanging;
            if ((handler != null))
            {
        ...
        protected override void OnParentChanging(IModelElement newParent, IModelElement oldParent)
        {
            ...
            this.OnPropertyChanging("UsageModel_UsageScenario");
        }
        ...
        {
            System.EventHandler<ValueChangedEventArgs> handler = this.UsageModel_UsageScenarioChanged;
            if ((handler != null))
            {
                handler.Invoke(this, eventArgs);
            }
        ...
        {
            System.EventHandler<ValueChangedEventArgs> handler = this.ScenarioBehaviour_UsageScenarioChanging;
            if ((handler != null))
            {
                handler.Invoke(this, eventArgs);
            }
        ...
        {
            System.EventHandler<ValueChangedEventArgs> handler = this.ScenarioBehaviour_UsageScenarioChanged;
            if ((handler != null))
            {
                handler.Invoke(this, eventArgs);
            }
        ...
        private void OnResetScenarioBehaviour_UsageScenario(object sender, System.EventArgs eventArgs)
        {
        ...
        {
            System.EventHandler<ValueChangedEventArgs> handler = this.Workload_UsageScenarioChanging;
            if ((handler != null))
            {
                handler.Invoke(this, eventArgs);
            }
        ...
        {
            System.EventHandler<ValueChangedEventArgs> handler = this.Workload_UsageScenarioChanged;
            if ((handler != null))
            {
                handler.Invoke(this, eventArgs);
            }
        ...
        /// <param name="sender">The object that sent this reset request</param>
        /// <param name="eventArgs">The event data for the reset event</param>
        private void OnResetWorkload_UsageScenario(object sender, System.EventArgs eventArgs)
        {
