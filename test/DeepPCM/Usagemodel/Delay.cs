...
namespace Metamodel.DeepPCM.Usagemodel
{
    ...
    [ModelRepresentationClassAttribute("http://github.com/ghmanager/DeepPCM/1.0#//usagemodel//Delay/")]
    [DebuggerDisplayAttribute("Delay {Id}")]
    public class Delay : AbstractUserAction, IDelay, IModelElement
    {
        ...
        public virtual IPCMRandomVariable TimeSpecification_Delay
        {
            get
            {
            ...
            set
            {
                if ((this._timeSpecification_Delay != value))
                {
                    ...
                    this.OnPropertyChanging("TimeSpecification_Delay", e);
                    ...
                    this.OnPropertyChanged("TimeSpecification_Delay", e);
                }
            }
        }
        ...
        public new static IClass ClassInstance
        {
            get
            {
                ...
                {
                    _classInstance = ((IClass)(MetaRepository.Instance.Resolve("http://github.com/ghmanager/DeepPCM/1.0#//usagemodel//Delay/")));
                }
        ...
        /// </summary>
        public event System.EventHandler<ValueChangedEventArgs> TimeSpecification_DelayChanging;
        
        /// <summary>
        /// Gets fired when the TimeSpecification_Delay property changed its value
        /// </summary>
        public event System.EventHandler<ValueChangedEventArgs> TimeSpecification_DelayChanged;
        ...
        {
            System.EventHandler<ValueChangedEventArgs> handler = this.TimeSpecification_DelayChanging;
            if ((handler != null))
            {
        ...
        {
            System.EventHandler<ValueChangedEventArgs> handler = this.TimeSpecification_DelayChanged;
            if ((handler != null))
            {
                handler.Invoke(this, eventArgs);
            }
        ...
        private void OnResetTimeSpecification_Delay(object sender, System.EventArgs eventArgs)
        {
        ...
        private sealed class TimeSpecification_DelayProxy : ModelPropertyChange<IDelay, IPCMRandomVariable>
        {
            ...
            {
                this.ModelElement.TimeSpecification_DelayChanged += handler;
            }
