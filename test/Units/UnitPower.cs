...
namespace Metamodel.Units
{
    ...
    public class UnitPower : Unit, IUnitPower, IModelElement
    {
        ...
        public virtual int Exponent
        {
            ...
            set
            {
                if ((this._exponent != value))
                {
                    ...
                    this.OnPropertyChanging("Exponent", e);
        ...
        /// </summary>
        public event System.EventHandler<ValueChangedEventArgs> ExponentChanging;
        
        /// <summary>
        /// Gets fired when the Exponent property changed its value
        /// </summary>
        public event System.EventHandler<ValueChangedEventArgs> ExponentChanged;
        ...
        {
            System.EventHandler<ValueChangedEventArgs> handler = this.ExponentChanging;
            if ((handler != null))
            {
        ...
        {
            System.EventHandler<ValueChangedEventArgs> handler = this.ExponentChanged;
            if ((handler != null))
            {
                handler.Invoke(this, eventArgs);
            }
