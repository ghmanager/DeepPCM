...
namespace Metamodel.Repo
{
    ...
    /// <summary>
    /// The public interface for Receiver
    /// </summary>
    [DefaultImplementationTypeAttribute(typeof(Receiver))]
    [XmlDefaultImplementationTypeAttribute(typeof(Receiver))]
    public interface IReceiver : IModelElement, IAssemblyContext
    {
        
        /// <summary>
        /// The BasicSubscriber property
        /// </summary>
        IEventGroup BasicSubscriber
        {
            get;
            set;
        }
        ...
        /// </summary>
        event System.EventHandler<ValueChangedEventArgs> BasicSubscriberChanging;
        
        /// <summary>
        /// Gets fired when the BasicSubscriber property changed its value
        /// </summary>
        event System.EventHandler<ValueChangedEventArgs> BasicSubscriberChanged;
    }
}
