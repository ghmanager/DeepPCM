...
namespace Metamodel.Repo
{
    ...
    /// <summary>
    /// The public interface for delegateTest
    /// </summary>
    [DefaultImplementationTypeAttribute(typeof(DelegateTest))]
    [XmlDefaultImplementationTypeAttribute(typeof(DelegateTest))]
    public interface IDelegateTest : IModelElement, IDelegationConnector
    {
    }
}
