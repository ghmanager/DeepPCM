...
namespace Metamodel.Repo
{
    ...
    /// <summary>
    /// The default implementation of the ChannelReceiver class
    /// </summary>
    [XmlNamespaceAttribute("http://github.com/ghmanager/EventRepo")]
    [XmlNamespacePrefixAttribute("repo")]
    [ModelRepresentationClassAttribute("http://github.com/ghmanager/EventRepo#//ChannelReceiver/")]
    [DebuggerDisplayAttribute("ChannelReceiver {Name}")]
    public class ChannelReceiver : MetaElement, IChannelReceiver, IModelElement
    {
        
        /// <summary>
        /// The backing field for the ChannelSubscriber property
        /// </summary>
        private IEventGroupChannel _channelSubscriber;
        ...
        public virtual IEventGroupChannel ChannelSubscriber
        {
            get
            {
                return this._channelSubscriber;
            }
            set
            {
                if ((this._channelSubscriber != value))
                {
                    IEventGroupChannel old = this._channelSubscriber;
                    ValueChangedEventArgs e = new ValueChangedEventArgs(old, value);
                    this.OnChannelSubscriberChanging(e);
                    this.OnPropertyChanging("ChannelSubscriber", e);
                    this._channelSubscriber = value;
                    if ((old != null))
                    {
                        old.Deleted -= this.OnResetChannelSubscriber;
                    }
                    if ((value != null))
                    {
                        value.Deleted += this.OnResetChannelSubscriber;
                    }
                    this.OnChannelSubscriberChanged(e);
                    this.OnPropertyChanged("ChannelSubscriber", e);
                }
            }
        }
        ...
        public override IEnumerableExpression<IModelElement> ReferencedElements
        {
            get
            {
                return base.ReferencedElements.Concat(new ChannelReceiverReferencedElementsCollection(this));
            }
        }
        ...
        public new static IRepositoryComponent RepositoryComponentInstance
        {
            get
            {
                ...
                {
                    _classInstance = ((IClass)(MetaRepository.Instance.Resolve("http://github.com/ghmanager/EventRepo#//ChannelReceiver/")));
                }
        ...
        /// </summary>
        public event System.EventHandler<ValueChangedEventArgs> ChannelSubscriberChanging;
        
        /// <summary>
        /// Gets fired when the ChannelSubscriber property changed its value
        /// </summary>
        public event System.EventHandler<ValueChangedEventArgs> ChannelSubscriberChanged;
        ...
        /// <summary>
        /// Raises the ChannelSubscriberChanging event
        /// </summary>
        /// <param name="eventArgs">The event data</param>
        protected virtual void OnChannelSubscriberChanging(ValueChangedEventArgs eventArgs)
        {
            System.EventHandler<ValueChangedEventArgs> handler = this.ChannelSubscriberChanging;
            if ((handler != null))
            {
        ...
        /// <summary>
        /// Raises the ChannelSubscriberChanged event
        /// </summary>
        /// <param name="eventArgs">The event data</param>
        protected virtual void OnChannelSubscriberChanged(ValueChangedEventArgs eventArgs)
        {
            System.EventHandler<ValueChangedEventArgs> handler = this.ChannelSubscriberChanged;
            if ((handler != null))
            {
                handler.Invoke(this, eventArgs);
            }
        ...
        /// <summary>
        /// Handles the event that the ChannelSubscriber property must reset
        /// </summary>
        /// <param name="sender">The object that sent this reset request</param>
        /// <param name="eventArgs">The event data for the reset event</param>
        private void OnResetChannelSubscriber(object sender, System.EventArgs eventArgs)
        {
            this.ChannelSubscriber = null;
        }
        ...
        {
            if ((feature == "CHANNELSUBSCRIBER"))
            {
                this.ChannelSubscriber = ((IEventGroupChannel)(value));
                return;
            }
        ...
        {
            if ((attribute == "CHANNELSUBSCRIBER"))
            {
                return new ChannelSubscriberProxy(this);
            }
        ...
        {
            if ((reference == "CHANNELSUBSCRIBER"))
            {
                return new ChannelSubscriberProxy(this);
            }
        ...
        /// </summary>
        public override IRepositoryComponent GetRepositoryComponent()
        {
            if ((_classInstance == null))
            {
                _classInstance = ((IClass)(MetaRepository.Instance.Resolve("http://github.com/ghmanager/EventRepo#//ChannelReceiver/")));
        ...
        /// </summary>
        public override IModelElement GetResourceRequiredInterfacesValue(IResourceRequiredInterface reference)
        {
        ...
        /// </summary>
        public override IModelElement GetRequiredInterfacesValue(IRequiredInterface reference)
        {
            return ((IModelElement)(this.GetReferencedElement(reference)));
        }
        ...
        /// <summary>
        /// The collection class to to represent the children of the ChannelReceiver class
        /// </summary>
        public class ChannelReceiverReferencedElementsCollection : ReferenceCollection, ICollectionExpression<IModelElement>, ICollection<IModelElement>
        {
            
            private ChannelReceiver _parent;
            
            /// <summary>
            /// Creates a new instance
            /// </summary>
            public ChannelReceiverReferencedElementsCollection(ChannelReceiver parent)
            {
                this._parent = parent;
            }
            ...
            public override int Count
            {
                ...
                {
                    int count = 0;
                    if ((this._parent.ChannelSubscriber != null))
                    {
                        count = (count + 1);
                    }
            ...
            {
                this._parent.ChannelSubscriberChanged += this.PropagateValueChanges;
            ...
            public override void Add(IModelElement item)
            {
                if ((this._parent.ChannelSubscriber == null))
                {
                    IEventGroupChannel channelSubscriberCasted = item.As<IEventGroupChannel>();
                    if ((channelSubscriberCasted != null))
                    {
                        this._parent.ChannelSubscriber = channelSubscriberCasted;
                        return;
                    }
                }
                if ((this._parent.ComposedStructure__AssemblyContext == null))
            ...
            {
                this._parent.ChannelSubscriber = null;
            ...
            {
                if ((item == this._parent.ChannelSubscriber))
                {
                    return true;
                }
            ...
            public override void CopyTo(IModelElement[] array, int arrayIndex)
            {
                if ((this._parent.ChannelSubscriber != null))
                {
                    array[arrayIndex] = this._parent.ChannelSubscriber;
            ...
            {
                if ((this._parent.ChannelSubscriber == item))
                {
                    this._parent.ChannelSubscriber = null;
                    return true;
                }
            ...
            {
                return Enumerable.Empty<IModelElement>().Concat(this._parent.ChannelSubscriber).Concat(this._parent.ComposedStructure__AssemblyContext).Concat(this._parent.ConfigParameterUsages__AssemblyContext).Concat(this._parent.DeclaringType).Concat(this._parent.Opposite).Concat(this._parent.Anchor).GetEnumerator();
            }
        }
        
        /// <summary>
        /// Represents a proxy to represent an incremental access to the ChannelSubscriber property
        /// </summary>
        private sealed class ChannelSubscriberProxy : ModelPropertyChange<IChannelReceiver, IEventGroupChannel>
        {
            ...
            public ChannelSubscriberProxy(IChannelReceiver modelElement) : 
                    base(modelElement)
            {
            }
            ...
            /// </summary>
            public override IEventGroupChannel Value
            {
                get
                {
                    return this.ModelElement.ChannelSubscriber;
                }
                set
                {
                    this.ModelElement.ChannelSubscriber = value;
                }
            }
            ...
            {
                this.ModelElement.ChannelSubscriberChanged += handler;
            }
