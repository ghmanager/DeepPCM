...
namespace Metamodel.Repo
{
    ...
    /// <summary>
    /// The default implementation of the Sender class
    /// </summary>
    [XmlNamespaceAttribute("http://github.com/ghmanager/EventRepo")]
    [XmlNamespacePrefixAttribute("repo")]
    [ModelRepresentationClassAttribute("http://github.com/ghmanager/EventRepo#//Sender/")]
    [DebuggerDisplayAttribute("Sender {Name}")]
    public class Sender : MetaElement, ISender, IModelElement
    {
        ...
        event EventHandler<ValueChangedEventArgs> ITypedElement.TypeChanged
        {
            add
            {
                IIReference _this_IReference = this;
        ...
        public new static IRepositoryComponent RepositoryComponentInstance
        {
            get
            {
                ...
                {
                    _classInstance = ((IClass)(MetaRepository.Instance.Resolve("http://github.com/ghmanager/EventRepo#//Sender/")));
                }
