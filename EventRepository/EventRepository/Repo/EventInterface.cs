...
namespace Metamodel.Repo
{
    ...
    /// <summary>
    /// The default implementation of the EventInterface class
    /// </summary>
    [XmlNamespaceAttribute("http://github.com/ghmanager/EventRepo")]
    [XmlNamespacePrefixAttribute("repo")]
    [ModelRepresentationClassAttribute("http://github.com/ghmanager/EventRepo#//EventInterface/")]
    [DebuggerDisplayAttribute("EventInterface {Name}")]
    public class EventInterface : MetaElement, IEventInterface, IModelElement
    {
        ...
        public new static IRepositoryComponent RepositoryComponentInstance
        {
            get
            {
                ...
                {
                    _classInstance = ((IClass)(MetaRepository.Instance.Resolve("http://github.com/ghmanager/EventRepo#//EventInterface/")));
                }
