...
namespace Metamodel.Repo
{
    ...
    /// <summary>
    /// The public interface for Sender
    /// </summary>
    [DefaultImplementationTypeAttribute(typeof(Sender))]
    [XmlDefaultImplementationTypeAttribute(typeof(Sender))]
    public interface ISender : IModelElement, IEventGroupChannel, IEventGroup, IEventInterface, IAssemblyContext
    {
    }
}
