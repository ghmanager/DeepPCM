...
namespace Metamodel.Repo
{
    ...
    [ModelRepresentationClassAttribute("http://github.com/ghmanager/EventRepo#//EventGroup/")]
    [DebuggerDisplayAttribute("EventGroup {Name}")]
    public class EventGroup : EventPublisher, IEventGroup, IModelElement
    {
        ...
        public new static IClass ClassInstance
        {
            get
            {
                ...
                {
                    _classInstance = ((IClass)(MetaRepository.Instance.Resolve("http://github.com/ghmanager/EventRepo#//EventGroup/")));
                }
