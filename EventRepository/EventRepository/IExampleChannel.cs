...
namespace Metamodel.Repo
{
    ...
    /// <summary>
    /// The public interface for ExampleChannel
    /// </summary>
    [DefaultImplementationTypeAttribute(typeof(ExampleChannel))]
    [XmlDefaultImplementationTypeAttribute(typeof(ExampleChannel))]
    public interface IExampleChannel : IModelElement, IEventChannelArchitecture
    {
    }
}
