...
namespace Metamodel.DeepPCM.Reliability
{
    ...
    [ModelRepresentationClassAttribute("http://github.com/ghmanager/DeepPCM/1.0#//reliability//NetworkInducedFailureType/" +
        "")]
    ...
    public class NetworkInducedFailureType : FailureType, INetworkInducedFailureType, IModelElement
    {
        ...
        public virtual ICommunicationLinkResourceType CommunicationLinkResourceType__NetworkInducedFailureType
        {
            ...
            set
            {
                if ((this._communicationLinkResourceType__NetworkInducedFailureType != value))
                {
                    ...
                    this.OnPropertyChanging("CommunicationLinkResourceType__NetworkInducedFailureType", e);
        ...
        public new static IClass ClassInstance
        {
            get
            {
                ...
                {
                    _classInstance = ((IClass)(MetaRepository.Instance.Resolve("http://github.com/ghmanager/DeepPCM/1.0#//reliability//NetworkInducedFailureType/" +
                            "")));
                }
        ...
        /// </summary>
        public event System.EventHandler<ValueChangedEventArgs> CommunicationLinkResourceType__NetworkInducedFailureTypeChanging;
        
        /// <summary>
        /// Gets fired when the CommunicationLinkResourceType__NetworkInducedFailureType property changed its value
        /// </summary>
        public event System.EventHandler<ValueChangedEventArgs> CommunicationLinkResourceType__NetworkInducedFailureTypeChanged;
        ...
        private void NetworkInducedFailureTypeHasCommunicationLinkResourceType(object diagnostics, object context)
        {
            if ((diagnostics != null))
            {
        ...
        {
            System.EventHandler<ValueChangedEventArgs> handler = this.CommunicationLinkResourceType__NetworkInducedFailureTypeChanging;
            if ((handler != null))
            {
        ...
        {
            System.EventHandler<ValueChangedEventArgs> handler = this.CommunicationLinkResourceType__NetworkInducedFailureTypeChanged;
            if ((handler != null))
            {
                handler.Invoke(this, eventArgs);
            }
        ...
        private void OnResetCommunicationLinkResourceType__NetworkInducedFailureType(object sender, System.EventArgs eventArgs)
        {
