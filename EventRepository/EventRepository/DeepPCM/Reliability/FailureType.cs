...
namespace Metamodel.DeepPCM.Reliability
{
    ...
    [ModelRepresentationClassAttribute("http://github.com/ghmanager/DeepPCM/1.0#//reliability//FailureType/")]
    [DebuggerDisplayAttribute("FailureType {Id}")]
    public abstract class FailureType : Metamodel.DeepPCM.Core.Entity.Entity, IFailureType, IModelElement
    {
        ...
        public new static IClass ClassInstance
        {
            get
            {
                ...
                {
                    _classInstance = ((IClass)(MetaRepository.Instance.Resolve("http://github.com/ghmanager/DeepPCM/1.0#//reliability//FailureType/")));
                }
        ...
        /// </summary>
        public event System.EventHandler<ValueChangedEventArgs> Repository__FailureTypeChanging;
        
        /// <summary>
        /// Gets fired when the Repository__FailureType property changed its value
        /// </summary>
        public event System.EventHandler<ValueChangedEventArgs> Repository__FailureTypeChanged;
        ...
        {
            System.EventHandler<ValueChangedEventArgs> handler = this.Repository__FailureTypeChanging;
            if ((handler != null))
            {
        ...
        protected override void OnParentChanging(IModelElement newParent, IModelElement oldParent)
        {
            ...
            this.OnPropertyChanging("Repository__FailureType");
        }
        ...
        {
            System.EventHandler<ValueChangedEventArgs> handler = this.Repository__FailureTypeChanged;
            if ((handler != null))
            {
                handler.Invoke(this, eventArgs);
            }
