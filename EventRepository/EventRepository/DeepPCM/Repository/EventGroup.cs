...
namespace Metamodel.DeepPCM.Repository
{
    ...
    [ModelRepresentationClassAttribute("http://github.com/ghmanager/DeepPCM/1.0#//repository//EventGroup/")]
    [DebuggerDisplayAttribute("EventGroup {Name}")]
    public class EventGroup : MetaElement, Metamodel.DeepPCM.Repository.IEventGroup, IModelElement
    {
        ...
        ICollectionExpression<IClass> IClass.BaseTypes
        {
            get
            {
                return new EventGroupBaseTypesCollection(this);
            }
        }
        ...
        public new static IClass ClassInstance
        {
            get
            {
                ...
                {
                    _classInstance = ((IClass)(MetaRepository.Instance.Resolve("http://github.com/ghmanager/DeepPCM/1.0#//repository//EventGroup/")));
                }
        ...
        private void EventTypes__EventGroupCollectionChanging(object sender, NMF.Collections.ObjectModel.NotifyCollectionChangingEventArgs e)
        {
            this.OnCollectionChanging("EventTypes__EventGroup", e);
        }
        ...
        public class EventGroupChildrenCollection : ReferenceCollection, ICollectionExpression<IModelElement>, ICollection<IModelElement>
        {
            ...
            {
                return Enumerable.Empty<IModelElement>().Concat(this._parent.EventTypes__EventGroup).Concat(this._parent.Protocols__Interface).Concat(this._parent.RequiredCharacterisations).GetEnumerator();
            }
        }
        ...
        public class EventGroupReferencedElementsCollection : ReferenceCollection, ICollectionExpression<IModelElement>, ICollection<IModelElement>
        {
            ...
            public override IEnumerator<IModelElement> GetEnumerator()
            {
                return Enumerable.Empty<IModelElement>().Concat(this._parent.EventTypes__EventGroup).Concat(this._parent.ParentInterfaces__Interface).Concat(this._parent.Protocols__Interface).Concat(this._parent.RequiredCharacterisations).Concat(this._parent.Repository__Interface).GetEnumerator();
            }
        }
