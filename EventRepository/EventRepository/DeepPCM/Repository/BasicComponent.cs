...
namespace Metamodel.DeepPCM.Repository
{
    ...
    public class BasicComponent : MetaElement, IBasicComponent, IModelElement
    {
        ...
        private void NoSeffTypeUsedTwice(object diagnostics, object context)
        {
            if ((diagnostics != null))
            {
        ...
        /// <param name="diagnostics"></param>
        /// <param name="context"></param>
        private void ProvideSameInterfacesAsImplementationType(object diagnostics, object context)
        {
            if ((diagnostics != null))
            {
                throw new ArgumentNullException("diagnostics");
        ...
        /// <param name="diagnostics"></param>
        /// <param name="context"></param>
        private void RequireSameInterfacesAsImplementationType(object diagnostics, object context)
        {
            if ((diagnostics != null))
            {
                throw new ArgumentNullException("diagnostics");
