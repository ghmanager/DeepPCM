...
namespace Metamodel.DeepPCM.Repository
{
    ...
    /// <summary>
    /// The collection class to implement the refined BaseTypes reference for the EventGroup class
    /// </summary>
    public class EventGroupBaseTypesCollection : ICollectionExpression<IClass>, ICollection<IClass>, INotifyCollection<IClass>
    {
        
        private Metamodel.DeepPCM.Repository.IEventGroup _parent;
        
        private static IClass[] _standardValues = new IClass[] {
                ((IClass)(NMF.Models.Repository.MetaRepository.Instance.Resolve("http://github.com/ghmanager/DeepPCM/1.0#//core//composition//EventPublisher/")))};
        
        /// <summary>
        /// Creates a new instance
        /// </summary>
        public EventGroupBaseTypesCollection(Metamodel.DeepPCM.Repository.IEventGroup parent)
        {
            this._parent = parent;
        }
        ...
        {
            if (EventGroupBaseTypesCollection._standardValues.Contains(item))
            {
                return true;
            }
            return false;
        ...
        {
            EventGroupBaseTypesCollection._standardValues.CopyTo(array, arrayIndex);
        ...
        {
            return EventGroupBaseTypesCollection._standardValues.Cast<IClass>().GetEnumerator();
        }
