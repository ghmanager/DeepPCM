...
namespace Metamodel.DeepPCM.Repository
{
    ...
    public class EventGroupEventTypes__EventGroupCollection : ObservableOppositeList<Metamodel.DeepPCM.Repository.IEventGroup, IEventType>
    {
        
        public EventGroupEventTypes__EventGroupCollection(Metamodel.DeepPCM.Repository.IEventGroup parent) : 
                base(parent)
        {
        }
        ...
        protected override void SetOpposite(IEventType item, Metamodel.DeepPCM.Repository.IEventGroup parent)
        {
            if ((parent != null))
            {
