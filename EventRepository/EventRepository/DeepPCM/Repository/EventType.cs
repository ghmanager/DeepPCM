...
namespace Metamodel.DeepPCM.Repository
{
    ...
    public class EventType : Signature, IEventType, IModelElement
    {
        ...
        public virtual Metamodel.DeepPCM.Repository.IEventGroup EventGroup__EventType
        {
            get
            {
                return ModelHelper.CastAs<Metamodel.DeepPCM.Repository.IEventGroup>(this.Parent);
            }
            set
            {
                this.Parent = value;
        ...
        {
            Metamodel.DeepPCM.Repository.IEventGroup oldEventGroup__EventType = ModelHelper.CastAs<Metamodel.DeepPCM.Repository.IEventGroup>(oldParent);
            Metamodel.DeepPCM.Repository.IEventGroup newEventGroup__EventType = ModelHelper.CastAs<Metamodel.DeepPCM.Repository.IEventGroup>(newParent);
        ...
        protected override void SetFeature(string feature, object value)
        {
            ...
            {
                this.EventGroup__EventType = ((Metamodel.DeepPCM.Repository.IEventGroup)(value));
                return;
            }
        ...
        public class EventTypeReferencedElementsCollection : ReferenceCollection, ICollectionExpression<IModelElement>, ICollection<IModelElement>
        {
            ...
            public override void Add(IModelElement item)
            {
                ...
                if ((this._parent.EventGroup__EventType == null))
                {
                    Metamodel.DeepPCM.Repository.IEventGroup eventGroup__EventTypeCasted = item.As<Metamodel.DeepPCM.Repository.IEventGroup>();
        ...
        /// </summary>
        private sealed class EventGroup__EventTypeProxy : ModelPropertyChange<IEventType, Metamodel.DeepPCM.Repository.IEventGroup>
        {
