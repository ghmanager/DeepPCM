...
namespace Metamodel.DeepPCM.Repository
{
    ...
    [ModelRepresentationClassAttribute("http://github.com/ghmanager/DeepPCM/1.0#//repository//CompleteComponentType/")]
    [DebuggerDisplayAttribute("CompleteComponentType {Name}")]
    public class CompleteComponentType : MetaElement, ICompleteComponentType, IModelElement
    {
        ...
        public new static IClass ClassInstance
        {
            get
            {
                ...
                {
                    _classInstance = ((IClass)(MetaRepository.Instance.Resolve("http://github.com/ghmanager/DeepPCM/1.0#//repository//CompleteComponentType/")));
                }
        ...
        private void AtLeastOneInterfaceHasToBeProvidedOrRequiredByAUsefullCompleteComponentType(object diagnostics, object context)
        {
            if ((diagnostics != null))
            {
        ...
        /// <param name="diagnostics"></param>
        /// <param name="context"></param>
        private void ProvidedInterfacesHaveToConformToProvidedType2(object diagnostics, object context)
        {
            if ((diagnostics != null))
            {
                throw new ArgumentNullException("diagnostics");
        ...
        private void ParentProvidesComponentTypesCollectionChanging(object sender, NMF.Collections.ObjectModel.NotifyCollectionChangingEventArgs e)
        {
            this.OnCollectionChanging("ParentProvidesComponentTypes", e);
        }
        ...
        public class CompleteComponentTypeReferencedElementsCollection : ReferenceCollection, ICollectionExpression<IModelElement>, ICollection<IModelElement>
        {
            ...
            {
                return Enumerable.Empty<IModelElement>().Concat(this._parent.ParentProvidesComponentTypes).Concat(this._parent.Repository__RepositoryComponent).Concat(this._parent.ProvidedInterfaces).Concat(this._parent.RequiredInterfaces).Concat(this._parent.ResourceRequiredInterfaces).GetEnumerator();
            }
        }
