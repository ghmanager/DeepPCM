...
namespace Metamodel.DeepPCM.Repository
{
    ...
    public class EventGroupSubscriber : MetaElement, IEventGroupSubscriber, IModelElement
    {
        ...
        /// </summary>
        private Metamodel.DeepPCM.Repository.IEventGroup _eventGroup;
        ...
        public virtual Metamodel.DeepPCM.Repository.IEventGroup EventGroup
        {
            get
            {
            ...
            set
            {
                ...
                {
                    Metamodel.DeepPCM.Repository.IEventGroup old = this._eventGroup;
        ...
        IInterface IRequiredInterface.Interface
        {
            ...
            set
            {
                ...
                if ((value != null))
                {
                    Metamodel.DeepPCM.Repository.IEventGroup @__EventGroup = value.As<Metamodel.DeepPCM.Repository.IEventGroup>();
        ...
        protected override void SetFeature(string feature, object value)
        {
            ...
            {
                this.EventGroup = ((Metamodel.DeepPCM.Repository.IEventGroup)(value));
                return;
            }
        ...
        public class EventGroupSubscriberReferencedElementsCollection : ReferenceCollection, ICollectionExpression<IModelElement>, ICollection<IModelElement>
        {
            ...
            public override void Add(IModelElement item)
            {
                if ((this._parent.EventGroup == null))
                {
                    Metamodel.DeepPCM.Repository.IEventGroup eventGroupCasted = item.As<Metamodel.DeepPCM.Repository.IEventGroup>();
        ...
        /// </summary>
        private sealed class EventGroupProxy : ModelPropertyChange<IEventGroupSubscriber, Metamodel.DeepPCM.Repository.IEventGroup>
        {
