...
namespace Metamodel.DeepPCM.Repository
{
    ...
    [ModelRepresentationClassAttribute("http://github.com/ghmanager/DeepPCM/1.0#//repository//ImplementationComponentType" +
        "/")]
    ...
    public abstract class ImplementationComponentType : MetaElement, IImplementationComponentType, IModelElement
    {
        ...
        public new static IClass ClassInstance
        {
            get
            {
                ...
                {
                    _classInstance = ((IClass)(MetaRepository.Instance.Resolve("http://github.com/ghmanager/DeepPCM/1.0#//repository//ImplementationComponentType" +
                            "/")));
                }
        ...
        public class ImplementationComponentTypeChildrenCollection : ReferenceCollection, ICollectionExpression<IModelElement>, ICollection<IModelElement>
        {
            ...
            {
                return Enumerable.Empty<IModelElement>().Concat(this._parent.ComponentParameterUsage_ImplementationComponentType).Concat(this._parent.ProvidedInterfaces).Concat(this._parent.RequiredInterfaces).Concat(this._parent.ResourceRequiredInterfaces).GetEnumerator();
            }
        }
