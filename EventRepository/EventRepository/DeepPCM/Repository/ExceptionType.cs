...
namespace Metamodel.DeepPCM.Repository
{
    ...
    [ModelRepresentationClassAttribute("http://github.com/ghmanager/DeepPCM/1.0#//repository//ExceptionType/")]
    public class ExceptionType : ModelElement, IExceptionType, IModelElement
    {
        ...
        public virtual string ExceptionName
        {
            ...
            set
            {
                if ((this._exceptionName != value))
                {
                    ...
                    this.OnPropertyChanging("ExceptionName", e);
        ...
        public virtual string ExceptionMessage
        {
            ...
            set
            {
                if ((this._exceptionMessage != value))
                {
                    ...
                    this.OnPropertyChanging("ExceptionMessage", e);
        ...
        public new static IClass ClassInstance
        {
            get
            {
                ...
                {
                    _classInstance = ((IClass)(MetaRepository.Instance.Resolve("http://github.com/ghmanager/DeepPCM/1.0#//repository//ExceptionType/")));
                }
        ...
        /// </summary>
        public event System.EventHandler<ValueChangedEventArgs> ExceptionNameChanging;
        
        /// <summary>
        /// Gets fired when the ExceptionName property changed its value
        /// </summary>
        public event System.EventHandler<ValueChangedEventArgs> ExceptionNameChanged;
        
        /// <summary>
        /// Gets fired before the ExceptionMessage property changes its value
        /// </summary>
        public event System.EventHandler<ValueChangedEventArgs> ExceptionMessageChanging;
        
        /// <summary>
        /// Gets fired when the ExceptionMessage property changed its value
        /// </summary>
        public event System.EventHandler<ValueChangedEventArgs> ExceptionMessageChanged;
        ...
        {
            System.EventHandler<ValueChangedEventArgs> handler = this.ExceptionNameChanging;
            if ((handler != null))
            {
        ...
        {
            System.EventHandler<ValueChangedEventArgs> handler = this.ExceptionNameChanged;
            if ((handler != null))
            {
                handler.Invoke(this, eventArgs);
            }
        ...
        {
            System.EventHandler<ValueChangedEventArgs> handler = this.ExceptionMessageChanging;
            if ((handler != null))
            {
                handler.Invoke(this, eventArgs);
            }
        ...
        {
            System.EventHandler<ValueChangedEventArgs> handler = this.ExceptionMessageChanged;
            if ((handler != null))
            {
                handler.Invoke(this, eventArgs);
            }
