...
namespace Metamodel.DeepPCM.Resourcetype
{
    ...
    /// <summary>
    /// The default implementation of the ResourceRequiredInterface class
    /// </summary>
    [XmlNamespaceAttribute("http://github.com/ghmanager/DeepPCM/ResourceType/1.0")]
    [XmlNamespacePrefixAttribute("resourcetype")]
    [ModelRepresentationClassAttribute("http://github.com/ghmanager/DeepPCM/1.0#//resourcetype//ResourceRequiredInterface" +
        "/")]
    [DebuggerDisplayAttribute("ResourceRequiredInterface {Id}")]
    public class ResourceRequiredInterface : MetaElement, IResourceRequiredInterface, IModelElement
    {
        ...
        /// </summary>
        [XmlElementNameAttribute("resourceInterfaceRequiringEntity")]
        [DesignerSerializationVisibilityAttribute(DesignerSerializationVisibility.Hidden)]
        [XmlAttributeAttribute(true)]
        [XmlOppositeAttribute("resourceRequiredInterfaces")]
        public virtual IResourceInterfaceRequiringEntity ResourceInterfaceRequiringEntity
        {
            get
            {
        ...
        public override IEnumerableExpression<IModelElement> ReferencedElements
        {
            get
            {
                return base.ReferencedElements.Concat(new ResourceRequiredInterfaceReferencedElementsCollection(this));
            }
        }
        ...
        public new static IClass ClassInstance
        {
            get
            {
                ...
                {
                    _classInstance = ((IClass)(MetaRepository.Instance.Resolve("http://github.com/ghmanager/DeepPCM/1.0#//resourcetype//ResourceRequiredInterface" +
                            "/")));
                }
        ...
        /// </summary>
        public event System.EventHandler<ValueChangedEventArgs> ResourceInterfaceRequiringEntityChanging;
        
        /// <summary>
        /// Gets fired when the ResourceInterfaceRequiringEntity property changed its value
        /// </summary>
        public event System.EventHandler<ValueChangedEventArgs> ResourceInterfaceRequiringEntityChanged;
        ...
        /// <summary>
        /// Raises the ResourceInterfaceRequiringEntityChanging event
        /// </summary>
        /// <param name="eventArgs">The event data</param>
        protected virtual void OnResourceInterfaceRequiringEntityChanging(ValueChangedEventArgs eventArgs)
        {
            System.EventHandler<ValueChangedEventArgs> handler = this.ResourceInterfaceRequiringEntityChanging;
            if ((handler != null))
            {
        ...
        /// <summary>
        /// Raises the ResourceInterfaceRequiringEntityChanged event
        /// </summary>
        /// <param name="eventArgs">The event data</param>
        protected virtual void OnResourceInterfaceRequiringEntityChanged(ValueChangedEventArgs eventArgs)
        {
            System.EventHandler<ValueChangedEventArgs> handler = this.ResourceInterfaceRequiringEntityChanged;
            if ((handler != null))
            {
                handler.Invoke(this, eventArgs);
            }
        ...
        {
            IResourceInterfaceRequiringEntity oldResourceInterfaceRequiringEntity = ModelHelper.CastAs<IResourceInterfaceRequiringEntity>(oldParent);
            IResourceInterfaceRequiringEntity newResourceInterfaceRequiringEntity = ModelHelper.CastAs<IResourceInterfaceRequiringEntity>(newParent);
            ValueChangedEventArgs e = new ValueChangedEventArgs(oldResourceInterfaceRequiringEntity, newResourceInterfaceRequiringEntity);
            this.OnResourceInterfaceRequiringEntityChanging(e);
            this.OnPropertyChanging("ResourceInterfaceRequiringEntity");
        ...
        protected override void OnParentChanged(IModelElement newParent, IModelElement oldParent)
        {
            IResourceInterfaceRequiringEntity oldResourceInterfaceRequiringEntity = ModelHelper.CastAs<IResourceInterfaceRequiringEntity>(oldParent);
            IResourceInterfaceRequiringEntity newResourceInterfaceRequiringEntity = ModelHelper.CastAs<IResourceInterfaceRequiringEntity>(newParent);
            if ((oldResourceInterfaceRequiringEntity != null))
            {
                oldResourceInterfaceRequiringEntity.ResourceRequiredInterfaces = null;
            }
            if ((newResourceInterfaceRequiringEntity != null))
            {
                newResourceInterfaceRequiringEntity.ResourceRequiredInterfaces = this;
            }
            ValueChangedEventArgs e = new ValueChangedEventArgs(oldResourceInterfaceRequiringEntity, newResourceInterfaceRequiringEntity);
            this.OnResourceInterfaceRequiringEntityChanged(e);
            this.OnPropertyChanged("ResourceInterfaceRequiringEntity", e);
            IReferenceType oldDeclaringType = ModelHelper.CastAs<IReferenceType>(oldParent);
            IReferenceType newDeclaringType = ModelHelper.CastAs<IReferenceType>(newParent);
        ...
        {
            if ((feature == "RESOURCEINTERFACEREQUIRINGENTITY"))
            {
                this.ResourceInterfaceRequiringEntity = ((IResourceInterfaceRequiringEntity)(value));
                return;
            }
        ...
        {
            if ((attribute == "RESOURCEINTERFACEREQUIRINGENTITY"))
            {
                return new ResourceInterfaceRequiringEntityProxy(this);
            }
        ...
        {
            if ((reference == "RESOURCEINTERFACEREQUIRINGENTITY"))
            {
                return new ResourceInterfaceRequiringEntityProxy(this);
            }
        ...
        /// <summary>
        /// The collection class to to represent the children of the ResourceRequiredInterface class
        /// </summary>
        public class ResourceRequiredInterfaceReferencedElementsCollection : ReferenceCollection, ICollectionExpression<IModelElement>, ICollection<IModelElement>
        {
            
            private ResourceRequiredInterface _parent;
            
            /// <summary>
            /// Creates a new instance
            /// </summary>
            public ResourceRequiredInterfaceReferencedElementsCollection(ResourceRequiredInterface parent)
            {
                this._parent = parent;
            }
            ...
            public override int Count
            {
                ...
                {
                    int count = 0;
                    if ((this._parent.ResourceInterfaceRequiringEntity != null))
                    {
                        count = (count + 1);
                    }
            ...
            {
                this._parent.ResourceInterfaceRequiringEntityChanged += this.PropagateValueChanges;
            ...
            public override void Add(IModelElement item)
            {
                if ((this._parent.ResourceInterfaceRequiringEntity == null))
                {
                    IResourceInterfaceRequiringEntity resourceInterfaceRequiringEntityCasted = item.As<IResourceInterfaceRequiringEntity>();
                    if ((resourceInterfaceRequiringEntityCasted != null))
                    {
                        this._parent.ResourceInterfaceRequiringEntity = resourceInterfaceRequiringEntityCasted;
                        return;
                    }
                }
                if ((this._parent.DeclaringType == null))
            ...
            {
                this._parent.ResourceInterfaceRequiringEntity = null;
            ...
            {
                if ((item == this._parent.ResourceInterfaceRequiringEntity))
                {
                    return true;
                }
            ...
            public override void CopyTo(IModelElement[] array, int arrayIndex)
            {
                if ((this._parent.ResourceInterfaceRequiringEntity != null))
                {
                    array[arrayIndex] = this._parent.ResourceInterfaceRequiringEntity;
            ...
            {
                if ((this._parent.ResourceInterfaceRequiringEntity == item))
                {
                    this._parent.ResourceInterfaceRequiringEntity = null;
                    return true;
                }
            ...
            {
                return Enumerable.Empty<IModelElement>().Concat(this._parent.ResourceInterfaceRequiringEntity).Concat(this._parent.DeclaringType).Concat(this._parent.Opposite).Concat(this._parent.ReferenceType).Concat(this._parent.Refines).Concat(this._parent.Anchor).GetEnumerator();
            }
        }
        
        /// <summary>
        /// Represents a proxy to represent an incremental access to the resourceInterfaceRequiringEntity property
        /// </summary>
        private sealed class ResourceInterfaceRequiringEntityProxy : ModelPropertyChange<IResourceRequiredInterface, IResourceInterfaceRequiringEntity>
        {
            ...
            public ResourceInterfaceRequiringEntityProxy(IResourceRequiredInterface modelElement) : 
                    base(modelElement)
            {
            }
            ...
            public override IResourceInterfaceRequiringEntity Value
            {
                get
                {
                    return this.ModelElement.ResourceInterfaceRequiringEntity;
                }
                set
                {
                    this.ModelElement.ResourceInterfaceRequiringEntity = value;
                }
            }
            ...
            {
                this.ModelElement.ResourceInterfaceRequiringEntityChanged += handler;
            }
