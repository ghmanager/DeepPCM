...
namespace Metamodel.DeepPCM.Resourcetype
{
    ...
    [ModelRepresentationClassAttribute("http://github.com/ghmanager/DeepPCM/1.0#//resourcetype//ProcessingResourceType/")]
    [DebuggerDisplayAttribute("ProcessingResourceType {Id}")]
    public class ProcessingResourceType : ReferenceType, IProcessingResourceType, IModelElement
    {
        ...
        public virtual IHardwareInducedFailureType HardwareInducedFailureType__ProcessingResourceType
        {
            ...
            set
            {
                if ((this._hardwareInducedFailureType__ProcessingResourceType != value))
                {
                    ...
                    this.OnPropertyChanging("HardwareInducedFailureType__ProcessingResourceType", e);
        ...
        public new static IClass ClassInstance
        {
            get
            {
                ...
                {
                    _classInstance = ((IClass)(MetaRepository.Instance.Resolve("http://github.com/ghmanager/DeepPCM/1.0#//resourcetype//ProcessingResourceType/")));
                }
        ...
        /// </summary>
        public event System.EventHandler<ValueChangedEventArgs> HardwareInducedFailureType__ProcessingResourceTypeChanging;
        
        /// <summary>
        /// Gets fired when the HardwareInducedFailureType__ProcessingResourceType property changed its value
        /// </summary>
        public event System.EventHandler<ValueChangedEventArgs> HardwareInducedFailureType__ProcessingResourceTypeChanged;
        ...
        {
            System.EventHandler<ValueChangedEventArgs> handler = this.HardwareInducedFailureType__ProcessingResourceTypeChanging;
            if ((handler != null))
            {
        ...
        {
            System.EventHandler<ValueChangedEventArgs> handler = this.HardwareInducedFailureType__ProcessingResourceTypeChanged;
            if ((handler != null))
            {
                handler.Invoke(this, eventArgs);
            }
        ...
        private void OnResetHardwareInducedFailureType__ProcessingResourceType(object sender, System.EventArgs eventArgs)
        {
