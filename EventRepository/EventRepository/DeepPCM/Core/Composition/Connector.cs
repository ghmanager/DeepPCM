...
namespace Metamodel.DeepPCM.Core.Composition
{
    ...
    [ModelRepresentationClassAttribute("http://github.com/ghmanager/DeepPCM/1.0#//core//composition//Connector/")]
    [DebuggerDisplayAttribute("Connector {Id}")]
    public abstract class Connector : Metamodel.DeepPCM.Core.Entity.Entity, IConnector, IModelElement
    {
        ...
        public virtual IComposedStructure ParentStructure__Connector
        {
            get
            {
        ...
        public new static IClass ClassInstance
        {
            get
            {
                ...
                {
                    _classInstance = ((IClass)(MetaRepository.Instance.Resolve("http://github.com/ghmanager/DeepPCM/1.0#//core//composition//Connector/")));
                }
        ...
        /// </summary>
        public event System.EventHandler<ValueChangedEventArgs> ParentStructure__ConnectorChanging;
        
        /// <summary>
        /// Gets fired when the ParentStructure__Connector property changed its value
        /// </summary>
        public event System.EventHandler<ValueChangedEventArgs> ParentStructure__ConnectorChanged;
        ...
        {
            System.EventHandler<ValueChangedEventArgs> handler = this.ParentStructure__ConnectorChanging;
            if ((handler != null))
            {
        ...
        protected override void OnParentChanging(IModelElement newParent, IModelElement oldParent)
        {
            ...
            this.OnPropertyChanging("ParentStructure__Connector");
        }
        ...
        {
            System.EventHandler<ValueChangedEventArgs> handler = this.ParentStructure__ConnectorChanged;
            if ((handler != null))
            {
                handler.Invoke(this, eventArgs);
            }
        ...
        protected override void OnParentChanged(IModelElement newParent, IModelElement oldParent)
        {
            ...
            this.OnPropertyChanged("ParentStructure__Connector", e);
        }
        ...
        private sealed class ParentStructure__ConnectorProxy : ModelPropertyChange<IConnector, IComposedStructure>
        {
            ...
            {
                this.ModelElement.ParentStructure__ConnectorChanged += handler;
            }
