...
namespace Metamodel.DeepPCM.Core.Composition
{
    ...
    public class EventChannelArchitecture : Class, IEventChannelArchitecture, IModelElement
    {
        ...
        [XmlElementNameAttribute("assemblyContexts")]
        ...
        public override IEnumerableExpression<IModelElement> Children
        {
            get
            {
                return base.Children.Concat(new EventChannelArchitectureChildrenCollection(this));
            }
        }
        ...
        private void AssemblyContextsCollectionChanging(object sender, NMF.Collections.ObjectModel.NotifyCollectionChangingEventArgs e)
        {
            this.OnCollectionChanging("AssemblyContexts", e);
        }
        ...
        /// </summary>
        public class EventChannelArchitectureChildrenCollection : ReferenceCollection, ICollectionExpression<IModelElement>, ICollection<IModelElement>
        {
            ...
            /// </summary>
            public EventChannelArchitectureChildrenCollection(EventChannelArchitecture parent)
            {
                this._parent = parent;
            }
        ...
        public class EventChannelArchitectureReferencedElementsCollection : ReferenceCollection, ICollectionExpression<IModelElement>, ICollection<IModelElement>
        {
            ...
            public override IEnumerator<IModelElement> GetEnumerator()
            {
                return Enumerable.Empty<IModelElement>().Concat(this._parent.ParentStructure__eventChannelArchitecture).Concat(this._parent.AssemblyContexts).GetEnumerator();
            }
        }
