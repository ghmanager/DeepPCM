...
namespace Metamodel.DeepPCM.Core.Composition
{
    ...
    /// <summary>
    /// The collection class to implement the refined BaseTypes reference for the ResourceDelegate class
    /// </summary>
    public class ResourceDelegateBaseTypesCollection : ICollectionExpression<IClass>, ICollection<IClass>, INotifyCollection<IClass>
    {
        
        private IResourceDelegate _parent;
        
        private static IClass[] _standardValues = new IClass[] {
                ((IClass)(NMF.Models.Repository.MetaRepository.Instance.Resolve("http://github.com/ghmanager/DeepPCM/1.0#//core//composition//ResourceDelegationCo" +
                        "nnector/")))};
        
        /// <summary>
        /// Creates a new instance
        /// </summary>
        public ResourceDelegateBaseTypesCollection(IResourceDelegate parent)
        {
            this._parent = parent;
            parent.ResourceTypeChanged += this.HandleValueChange;
        }
        ...
        {
            if (ResourceDelegateBaseTypesCollection._standardValues.Contains(item))
            {
                return true;
            }
        ...
        {
            ResourceDelegateBaseTypesCollection._standardValues.CopyTo(array, arrayIndex);
        ...
        {
            return ResourceDelegateBaseTypesCollection._standardValues.Cast<IClass>().Concat(this._parent.ResourceType).GetEnumerator();
        }
