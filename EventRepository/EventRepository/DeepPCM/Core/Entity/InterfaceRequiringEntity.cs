...
namespace Metamodel.DeepPCM.Core.Entity
{
    ...
    [ModelRepresentationClassAttribute("http://github.com/ghmanager/DeepPCM/1.0#//core//entity//InterfaceRequiringEntity/" +
        "")]
    [DebuggerDisplayAttribute("InterfaceRequiringEntity {Name}")]
    public abstract class InterfaceRequiringEntity : StructuredType, IInterfaceRequiringEntity, IModelElement
    {
        ...
        public new static IClass ClassInstance
        {
            get
            {
                ...
                {
                    _classInstance = ((IClass)(MetaRepository.Instance.Resolve("http://github.com/ghmanager/DeepPCM/1.0#//core//entity//InterfaceRequiringEntity/" +
                            "")));
                }
        ...
        public class InterfaceRequiringEntityChildrenCollection : ReferenceCollection, ICollectionExpression<IModelElement>, ICollection<IModelElement>
        {
            ...
            {
                return Enumerable.Empty<IModelElement>().Concat(this._parent.RequiredInterfaces).Concat(this._parent.AttributeConstraints).Concat(this._parent.ReferenceConstraints).Concat(this._parent.Events).Concat(this._parent.ResourceRequiredInterfaces).GetEnumerator();
            }
        }
        ...
        public class InterfaceRequiringEntityReferencedElementsCollection : ReferenceCollection, ICollectionExpression<IModelElement>, ICollection<IModelElement>
        {
            ...
            public override IEnumerator<IModelElement> GetEnumerator()
            {
                return Enumerable.Empty<IModelElement>().Concat(this._parent.RequiredInterfaces).Concat(this._parent.BaseTypes).Concat(this._parent.InstanceOf).Concat(this._parent.Identifier).Concat(this._parent.AttributeConstraints).Concat(this._parent.ReferenceConstraints).Concat(this._parent.Events).Concat(this._parent.ResourceRequiredInterfaces).GetEnumerator();
            }
        }
