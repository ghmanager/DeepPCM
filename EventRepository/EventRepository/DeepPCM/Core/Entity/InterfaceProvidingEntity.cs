...
namespace Metamodel.DeepPCM.Core.Entity
{
    ...
    [ModelRepresentationClassAttribute("http://github.com/ghmanager/DeepPCM/1.0#//core//entity//InterfaceProvidingEntity/" +
        "")]
    [DebuggerDisplayAttribute("InterfaceProvidingEntity {Name}")]
    public abstract class InterfaceProvidingEntity : ReferenceType, IInterfaceProvidingEntity, IModelElement
    {
        ...
        public new static IClass ClassInstance
        {
            get
            {
                ...
                {
                    _classInstance = ((IClass)(MetaRepository.Instance.Resolve("http://github.com/ghmanager/DeepPCM/1.0#//core//entity//InterfaceProvidingEntity/" +
                            "")));
                }
        ...
        public class InterfaceProvidingEntityChildrenCollection : ReferenceCollection, ICollectionExpression<IModelElement>, ICollection<IModelElement>
        {
            ...
            {
                return Enumerable.Empty<IModelElement>().Concat(this._parent.ProvidedInterfaces).Concat(this._parent.AttributeConstraints).Concat(this._parent.ReferenceConstraints).GetEnumerator();
            }
        }
        ...
        public class InterfaceProvidingEntityReferencedElementsCollection : ReferenceCollection, ICollectionExpression<IModelElement>, ICollection<IModelElement>
        {
            ...
            public override IEnumerator<IModelElement> GetEnumerator()
            {
                return Enumerable.Empty<IModelElement>().Concat(this._parent.ProvidedInterfaces).Concat(this._parent.InstanceOf).Concat(this._parent.Identifier).Concat(this._parent.AttributeConstraints).Concat(this._parent.ReferenceConstraints).GetEnumerator();
            }
        }
