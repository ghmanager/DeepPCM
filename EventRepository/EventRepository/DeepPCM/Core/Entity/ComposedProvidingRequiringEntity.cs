...
namespace Metamodel.DeepPCM.Core.Entity
{
    ...
    [ModelRepresentationClassAttribute("http://github.com/ghmanager/DeepPCM/1.0#//core//entity//ComposedProvidingRequirin" +
        "gEntity/")]
    [DebuggerDisplayAttribute("ComposedProvidingRequiringEntity {Id}")]
    public abstract class ComposedProvidingRequiringEntity : StructuredType, IComposedProvidingRequiringEntity, IModelElement
    {
        ...
        ICollectionExpression<IClass> IClass.BaseTypes
        {
            get
            {
                return new InterfaceProvidingEntityBaseTypesCollection(this);
            }
        }
        ...
        public new static IClass ClassInstance
        {
            get
            {
                ...
                {
                    _classInstance = ((IClass)(MetaRepository.Instance.Resolve("http://github.com/ghmanager/DeepPCM/1.0#//core//entity//ComposedProvidingRequirin" +
                            "gEntity/")));
                }
