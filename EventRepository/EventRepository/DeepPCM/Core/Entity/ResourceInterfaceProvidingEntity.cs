...
namespace Metamodel.DeepPCM.Core.Entity
{
    ...
    [ModelRepresentationClassAttribute("http://github.com/ghmanager/DeepPCM/1.0#//core//entity//ResourceInterfaceProvidin" +
        "gEntity/")]
    [DebuggerDisplayAttribute("ResourceInterfaceProvidingEntity {Name}")]
    public abstract class ResourceInterfaceProvidingEntity : ReferenceType, IResourceInterfaceProvidingEntity, IModelElement
    {
        ...
        public class ResourceInterfaceProvidingEntityChildrenCollection : ReferenceCollection, ICollectionExpression<IModelElement>, ICollection<IModelElement>
        {
            ...
            {
                return Enumerable.Empty<IModelElement>().Concat(this._parent.ProvidedResourceInterfaces).Concat(this._parent.AttributeConstraints).Concat(this._parent.ReferenceConstraints).GetEnumerator();
            }
        }
        ...
        public class ResourceInterfaceProvidingEntityReferencedElementsCollection : ReferenceCollection, ICollectionExpression<IModelElement>, ICollection<IModelElement>
        {
            ...
            public override IEnumerator<IModelElement> GetEnumerator()
            {
                return Enumerable.Empty<IModelElement>().Concat(this._parent.ProvidedResourceInterfaces).Concat(this._parent.InstanceOf).Concat(this._parent.Identifier).Concat(this._parent.AttributeConstraints).Concat(this._parent.ReferenceConstraints).GetEnumerator();
            }
        }
