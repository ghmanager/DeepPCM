...
namespace Metamodel.DeepPCM.Seff
{
    ...
    [ModelRepresentationClassAttribute("http://github.com/ghmanager/DeepPCM/1.0#//seff//InternalAction/")]
    [DebuggerDisplayAttribute("InternalAction {Id}")]
    public class InternalAction : AbstractInternalControlFlowAction, IInternalAction, IModelElement
    {
        ...
        [ConstantAttribute()]
        public virtual ICollectionExpression<IInternalFailureOccurrenceDescription> InternalFailureOccurrenceDescriptions__InternalAction
        {
            get
            {
        ...
        public new static IClass ClassInstance
        {
            get
            {
                ...
                {
                    _classInstance = ((IClass)(MetaRepository.Instance.Resolve("http://github.com/ghmanager/DeepPCM/1.0#//seff//InternalAction/")));
                }
        ...
        private void MultipleInternalOccurrenceDescriptionsPerFailureTypeNotAllowed(object diagnostics, object context)
        {
            if ((diagnostics != null))
            {
        ...
        /// <param name="diagnostics"></param>
        /// <param name="context"></param>
        private void SumOfInternalActionFailureProbabilitiesMustNotExceed1(object diagnostics, object context)
        {
            if ((diagnostics != null))
            {
                throw new ArgumentNullException("diagnostics");
        ...
        private void InternalFailureOccurrenceDescriptions__InternalActionCollectionChanging(object sender, NMF.Collections.ObjectModel.NotifyCollectionChangingEventArgs e)
        {
            this.OnCollectionChanging("InternalFailureOccurrenceDescriptions__InternalAction", e);
        }
        ...
        /// <param name="sender">The collection that raised the change</param>
        /// <param name="e">The original event data</param>
        private void InternalFailureOccurrenceDescriptions__InternalActionCollectionChanged(object sender, System.Collections.Specialized.NotifyCollectionChangedEventArgs e)
        {
            this.OnCollectionChanged("InternalFailureOccurrenceDescriptions__InternalAction", e);
        }
