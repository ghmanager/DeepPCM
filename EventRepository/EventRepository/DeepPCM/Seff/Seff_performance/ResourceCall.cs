...
namespace Metamodel.DeepPCM.Seff.Seff_performance
{
    ...
    [ModelRepresentationClassAttribute("http://github.com/ghmanager/DeepPCM/1.0#//seff//seff_performance//ResourceCall/")]
    public class ResourceCall : CallAction, IResourceCall, IModelElement
    {
        
        /// <summary>
        /// The backing field for the ResourceRequiredInterface__ResourceCall property
        /// </summary>
        private IResourceRequiredInterface _resourceRequiredInterface__ResourceCall;
        ...
        /// <summary>
        /// The resourceRequiredInterface__ResourceCall property
        /// </summary>
        [XmlElementNameAttribute("resourceRequiredInterface__ResourceCall")]
        [XmlAttributeAttribute(true)]
        public virtual IResourceRequiredInterface ResourceRequiredInterface__ResourceCall
        {
            get
            {
                return this._resourceRequiredInterface__ResourceCall;
            }
            set
            {
                if ((this._resourceRequiredInterface__ResourceCall != value))
                {
                    IResourceRequiredInterface old = this._resourceRequiredInterface__ResourceCall;
                    ValueChangedEventArgs e = new ValueChangedEventArgs(old, value);
                    this.OnResourceRequiredInterface__ResourceCallChanging(e);
                    this.OnPropertyChanging("ResourceRequiredInterface__ResourceCall", e);
                    this._resourceRequiredInterface__ResourceCall = value;
                    if ((old != null))
                    {
                        old.Deleted -= this.OnResetResourceRequiredInterface__ResourceCall;
                    }
                    if ((value != null))
                    {
                        value.Deleted += this.OnResetResourceRequiredInterface__ResourceCall;
                    }
                    this.OnResourceRequiredInterface__ResourceCallChanged(e);
                    this.OnPropertyChanged("ResourceRequiredInterface__ResourceCall", e);
                }
            }
        }
        ...
        public virtual IResourceSignature Signature__ResourceCall
        {
            ...
            set
            {
                if ((this._signature__ResourceCall != value))
                {
                    ...
                    this.OnPropertyChanging("Signature__ResourceCall", e);
        ...
        public virtual IPCMRandomVariable NumberOfCalls__ResourceCall
        {
            ...
            set
            {
                if ((this._numberOfCalls__ResourceCall != value))
                {
                    ...
                    this.OnPropertyChanging("NumberOfCalls__ResourceCall", e);
        ...
        public new static IClass ClassInstance
        {
            get
            {
                ...
                {
                    _classInstance = ((IClass)(MetaRepository.Instance.Resolve("http://github.com/ghmanager/DeepPCM/1.0#//seff//seff_performance//ResourceCall/")));
                }
        ...
        /// </summary>
        public event System.EventHandler<ValueChangedEventArgs> Action__ResourceCallChanging;
        
        /// <summary>
        /// Gets fired when the Action__ResourceCall property changed its value
        /// </summary>
        public event System.EventHandler<ValueChangedEventArgs> Action__ResourceCallChanged;
        
        /// <summary>
        /// Gets fired before the ResourceRequiredInterface__ResourceCall property changes its value
        /// </summary>
        public event System.EventHandler<ValueChangedEventArgs> ResourceRequiredInterface__ResourceCallChanging;
        
        /// <summary>
        /// Gets fired when the ResourceRequiredInterface__ResourceCall property changed its value
        /// </summary>
        public event System.EventHandler<ValueChangedEventArgs> ResourceRequiredInterface__ResourceCallChanged;
        
        /// <summary>
        /// Gets fired before the Signature__ResourceCall property changes its value
        /// </summary>
        public event System.EventHandler<ValueChangedEventArgs> Signature__ResourceCallChanging;
        
        /// <summary>
        /// Gets fired when the Signature__ResourceCall property changed its value
        /// </summary>
        public event System.EventHandler<ValueChangedEventArgs> Signature__ResourceCallChanged;
        
        /// <summary>
        /// Gets fired before the NumberOfCalls__ResourceCall property changes its value
        /// </summary>
        public event System.EventHandler<ValueChangedEventArgs> NumberOfCalls__ResourceCallChanging;
        
        /// <summary>
        /// Gets fired when the NumberOfCalls__ResourceCall property changed its value
        /// </summary>
        public event System.EventHandler<ValueChangedEventArgs> NumberOfCalls__ResourceCallChanged;
        ...
        private void ResourceSignatureBelongsToResourceRequiredInterface(object diagnostics, object context)
        {
            if ((diagnostics != null))
            {
        ...
        {
            System.EventHandler<ValueChangedEventArgs> handler = this.Action__ResourceCallChanging;
            if ((handler != null))
            {
        ...
        protected override void OnParentChanging(IModelElement newParent, IModelElement oldParent)
        {
            ...
            this.OnPropertyChanging("Action__ResourceCall");
        }
        ...
        {
            System.EventHandler<ValueChangedEventArgs> handler = this.Action__ResourceCallChanged;
            if ((handler != null))
            {
                handler.Invoke(this, eventArgs);
            }
        ...
        /// <summary>
        /// Raises the ResourceRequiredInterface__ResourceCallChanging event
        /// </summary>
        /// <param name="eventArgs">The event data</param>
        protected virtual void OnResourceRequiredInterface__ResourceCallChanging(ValueChangedEventArgs eventArgs)
        {
            System.EventHandler<ValueChangedEventArgs> handler = this.ResourceRequiredInterface__ResourceCallChanging;
            if ((handler != null))
            {
                handler.Invoke(this, eventArgs);
            }
        ...
        /// <summary>
        /// Raises the ResourceRequiredInterface__ResourceCallChanged event
        /// </summary>
        /// <param name="eventArgs">The event data</param>
        protected virtual void OnResourceRequiredInterface__ResourceCallChanged(ValueChangedEventArgs eventArgs)
        {
            System.EventHandler<ValueChangedEventArgs> handler = this.ResourceRequiredInterface__ResourceCallChanged;
            if ((handler != null))
            {
                handler.Invoke(this, eventArgs);
            }
        ...
        /// <summary>
        /// Handles the event that the ResourceRequiredInterface__ResourceCall property must reset
        /// </summary>
        /// <param name="sender">The object that sent this reset request</param>
        /// <param name="eventArgs">The event data for the reset event</param>
        private void OnResetResourceRequiredInterface__ResourceCall(object sender, System.EventArgs eventArgs)
        {
            this.ResourceRequiredInterface__ResourceCall = null;
        }
        ...
        {
            System.EventHandler<ValueChangedEventArgs> handler = this.Signature__ResourceCallChanging;
            if ((handler != null))
            {
                handler.Invoke(this, eventArgs);
            }
        ...
        {
            System.EventHandler<ValueChangedEventArgs> handler = this.Signature__ResourceCallChanged;
            if ((handler != null))
            {
                handler.Invoke(this, eventArgs);
            }
        ...
        /// <param name="sender">The object that sent this reset request</param>
        /// <param name="eventArgs">The event data for the reset event</param>
        private void OnResetSignature__ResourceCall(object sender, System.EventArgs eventArgs)
        {
        ...
        {
            System.EventHandler<ValueChangedEventArgs> handler = this.NumberOfCalls__ResourceCallChanging;
            if ((handler != null))
            {
                handler.Invoke(this, eventArgs);
            }
        ...
        {
            System.EventHandler<ValueChangedEventArgs> handler = this.NumberOfCalls__ResourceCallChanged;
            if ((handler != null))
            {
                handler.Invoke(this, eventArgs);
            }
        ...
        /// <param name="sender">The object that sent this reset request</param>
        /// <param name="eventArgs">The event data for the reset event</param>
        private void OnResetNumberOfCalls__ResourceCall(object sender, System.EventArgs eventArgs)
        {
        ...
        protected override void SetFeature(string feature, object value)
        {
            ...
            if ((feature == "RESOURCEREQUIREDINTERFACE__RESOURCECALL"))
            {
                this.ResourceRequiredInterface__ResourceCall = ((IResourceRequiredInterface)(value));
                return;
            }
        ...
        protected override NMF.Expressions.INotifyExpression<object> GetExpressionForAttribute(string attribute)
        {
            ...
            if ((attribute == "RESOURCEREQUIREDINTERFACE__RESOURCECALL"))
            {
                return new ResourceRequiredInterface__ResourceCallProxy(this);
            }
        ...
        protected override NMF.Expressions.INotifyExpression<NMF.Models.IModelElement> GetExpressionForReference(string reference)
        {
            ...
            if ((reference == "RESOURCEREQUIREDINTERFACE__RESOURCECALL"))
            {
                return new ResourceRequiredInterface__ResourceCallProxy(this);
            }
        ...
        public class ResourceCallReferencedElementsCollection : ReferenceCollection, ICollectionExpression<IModelElement>, ICollection<IModelElement>
        {
            ...
            public override int Count
            {
                get
                {
                    ...
                    if ((this._parent.ResourceRequiredInterface__ResourceCall != null))
                    {
                        count = (count + 1);
                    }
            ...
            protected override void AttachCore()
            {
                ...
                this._parent.ResourceRequiredInterface__ResourceCallChanged += this.PropagateValueChanges;
            ...
            public override void Add(IModelElement item)
            {
                ...
                if ((this._parent.ResourceRequiredInterface__ResourceCall == null))
                {
                    IResourceRequiredInterface resourceRequiredInterface__ResourceCallCasted = item.As<IResourceRequiredInterface>();
                    if ((resourceRequiredInterface__ResourceCallCasted != null))
                    {
                        this._parent.ResourceRequiredInterface__ResourceCall = resourceRequiredInterface__ResourceCallCasted;
                        return;
                    }
                }
                if ((this._parent.Signature__ResourceCall == null))
            ...
            public override void Clear()
            {
                ...
                this._parent.ResourceRequiredInterface__ResourceCall = null;
            ...
            public override bool Contains(IModelElement item)
            {
                ...
                if ((item == this._parent.ResourceRequiredInterface__ResourceCall))
                {
                    return true;
                }
            ...
            public override void CopyTo(IModelElement[] array, int arrayIndex)
            {
                ...
                if ((this._parent.ResourceRequiredInterface__ResourceCall != null))
                {
                    array[arrayIndex] = this._parent.ResourceRequiredInterface__ResourceCall;
                    arrayIndex = (arrayIndex + 1);
                }
                if ((this._parent.Signature__ResourceCall != null))
                {
            ...
            public override bool Remove(IModelElement item)
            {
                ...
                if ((this._parent.ResourceRequiredInterface__ResourceCall == item))
                {
                    this._parent.ResourceRequiredInterface__ResourceCall = null;
                    return true;
                }
            ...
            public override IEnumerator<IModelElement> GetEnumerator()
            {
                return Enumerable.Empty<IModelElement>().Concat(this._parent.Action__ResourceCall).Concat(this._parent.ResourceRequiredInterface__ResourceCall).Concat(this._parent.Signature__ResourceCall).Concat(this._parent.NumberOfCalls__ResourceCall).GetEnumerator();
            }
        }
        ...
        /// <summary>
        /// Represents a proxy to represent an incremental access to the resourceRequiredInterface__ResourceCall property
        /// </summary>
        private sealed class ResourceRequiredInterface__ResourceCallProxy : ModelPropertyChange<IResourceCall, IResourceRequiredInterface>
        {
            ...
            /// </summary>
            /// <param name="modelElement">The model instance element for which to create the property access proxy</param>
            public ResourceRequiredInterface__ResourceCallProxy(IResourceCall modelElement) : 
                    base(modelElement)
            {
            }
            ...
            public override IResourceRequiredInterface Value
            {
                get
                {
                    return this.ModelElement.ResourceRequiredInterface__ResourceCall;
                }
                set
                {
                    this.ModelElement.ResourceRequiredInterface__ResourceCall = value;
                }
            }
            ...
            protected override void RegisterChangeEventHandler(System.EventHandler<NMF.Expressions.ValueChangedEventArgs> handler)
            {
                this.ModelElement.ResourceRequiredInterface__ResourceCallChanged += handler;
            }
