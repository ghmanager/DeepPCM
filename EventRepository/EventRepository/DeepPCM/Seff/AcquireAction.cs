...
namespace Metamodel.DeepPCM.Seff
{
    ...
    [ModelRepresentationClassAttribute("http://github.com/ghmanager/DeepPCM/1.0#//seff//AcquireAction/")]
    ...
    public class AcquireAction : AbstractInternalControlFlowAction, IAcquireAction, IModelElement
    {
        ...
        public virtual bool Timeout
        {
            ...
            set
            {
                if ((this._timeout != value))
                {
                    ...
                    this.OnPropertyChanging("Timeout", e);
                    this._timeout = value;
        ...
        public virtual double TimeoutValue
        {
            ...
            set
            {
                if ((this._timeoutValue != value))
                {
                    ...
                    this.OnPropertyChanging("TimeoutValue", e);
        ...
        public virtual IPassiveResource Passiveresource_AcquireAction
        {
            ...
            set
            {
                if ((this._passiveresource_AcquireAction != value))
                {
                    ...
                    this.OnPropertyChanging("Passiveresource_AcquireAction", e);
        ...
        public new static IClass ClassInstance
        {
            get
            {
                ...
                {
                    _classInstance = ((IClass)(MetaRepository.Instance.Resolve("http://github.com/ghmanager/DeepPCM/1.0#//seff//AcquireAction/")));
                }
        ...
        /// </summary>
        public event System.EventHandler<ValueChangedEventArgs> TimeoutValueChanging;
        
        /// <summary>
        /// Gets fired when the TimeoutValue property changed its value
        /// </summary>
        public event System.EventHandler<ValueChangedEventArgs> TimeoutValueChanged;
        
        /// <summary>
        /// Gets fired before the Passiveresource_AcquireAction property changes its value
        /// </summary>
        public event System.EventHandler<ValueChangedEventArgs> Passiveresource_AcquireActionChanging;
        
        /// <summary>
        /// Gets fired when the Passiveresource_AcquireAction property changed its value
        /// </summary>
        public event System.EventHandler<ValueChangedEventArgs> Passiveresource_AcquireActionChanged;
        ...
        private void TimeoutValueOfAcquireActionMustNotBeNegative(object diagnostics, object context)
        {
            if ((diagnostics != null))
            {
        ...
        {
            System.EventHandler<ValueChangedEventArgs> handler = this.TimeoutValueChanging;
            if ((handler != null))
            {
                handler.Invoke(this, eventArgs);
            }
        ...
        {
            System.EventHandler<ValueChangedEventArgs> handler = this.TimeoutValueChanged;
            if ((handler != null))
            {
                handler.Invoke(this, eventArgs);
            }
        ...
        {
            System.EventHandler<ValueChangedEventArgs> handler = this.Passiveresource_AcquireActionChanging;
            if ((handler != null))
            {
                handler.Invoke(this, eventArgs);
            }
        ...
        {
            System.EventHandler<ValueChangedEventArgs> handler = this.Passiveresource_AcquireActionChanged;
            if ((handler != null))
            {
                handler.Invoke(this, eventArgs);
            }
        ...
        private void OnResetPassiveresource_AcquireAction(object sender, System.EventArgs eventArgs)
        {
