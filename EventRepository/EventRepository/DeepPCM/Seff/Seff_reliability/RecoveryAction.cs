...
namespace Metamodel.DeepPCM.Seff.Seff_reliability
{
    ...
    [ModelRepresentationClassAttribute("http://github.com/ghmanager/DeepPCM/1.0#//seff//seff_reliability//RecoveryAction/" +
        "")]
    ...
    public class RecoveryAction : AbstractInternalControlFlowAction, IRecoveryAction, IModelElement
    {
        ...
        public virtual IRecoveryActionBehaviour PrimaryBehaviour__RecoveryAction
        {
            ...
            set
            {
                if ((this._primaryBehaviour__RecoveryAction != value))
                {
                    ...
                    this.OnPropertyChanging("PrimaryBehaviour__RecoveryAction", e);
        ...
        public new static IClass ClassInstance
        {
            get
            {
                ...
                {
                    _classInstance = ((IClass)(MetaRepository.Instance.Resolve("http://github.com/ghmanager/DeepPCM/1.0#//seff//seff_reliability//RecoveryAction/" +
                            "")));
                }
        ...
        /// </summary>
        public event System.EventHandler<ValueChangedEventArgs> PrimaryBehaviour__RecoveryActionChanging;
        
        /// <summary>
        /// Gets fired when the PrimaryBehaviour__RecoveryAction property changed its value
        /// </summary>
        public event System.EventHandler<ValueChangedEventArgs> PrimaryBehaviour__RecoveryActionChanged;
        ...
        private void PrimaryBehaviourOfRecoveryActionMustBeSet(object diagnostics, object context)
        {
            if ((diagnostics != null))
            {
        ...
        {
            System.EventHandler<ValueChangedEventArgs> handler = this.PrimaryBehaviour__RecoveryActionChanging;
            if ((handler != null))
            {
        ...
        {
            System.EventHandler<ValueChangedEventArgs> handler = this.PrimaryBehaviour__RecoveryActionChanged;
            if ((handler != null))
            {
                handler.Invoke(this, eventArgs);
            }
        ...
        private void OnResetPrimaryBehaviour__RecoveryAction(object sender, System.EventArgs eventArgs)
        {
        ...
        private void RecoveryActionBehaviours__RecoveryActionCollectionChanging(object sender, NMF.Collections.ObjectModel.NotifyCollectionChangingEventArgs e)
        {
            this.OnCollectionChanging("RecoveryActionBehaviours__RecoveryAction", e);
        }
