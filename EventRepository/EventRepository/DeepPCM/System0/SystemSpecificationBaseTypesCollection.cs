...
namespace Metamodel.DeepPCM.System0
{
    ...
    public class SystemSpecificationBaseTypesCollection : ICollectionExpression<IClass>, ICollection<IClass>, INotifyCollection<IClass>
    {
        ...
        private static IClass[] _standardValues = new IClass[] {
                ((IClass)(NMF.Models.Repository.MetaRepository.Instance.Resolve("http://github.com/ghmanager/DeepPCM/1.0#//system0//SystemArchitecture/")))};
        ...
        {
            return SystemSpecificationBaseTypesCollection._standardValues.Cast<IClass>().Concat(this._parent.ProvidedInterfaces).GetEnumerator();
        }
