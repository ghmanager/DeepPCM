...
namespace Metamodel.DeepPCM.Usagemodel
{
    ...
    [ModelRepresentationClassAttribute("http://github.com/ghmanager/DeepPCM/1.0#//usagemodel//ScenarioBehaviour/")]
    [DebuggerDisplayAttribute("ScenarioBehaviour {Id}")]
    public class ScenarioBehaviour : Metamodel.DeepPCM.Core.Entity.Entity, IScenarioBehaviour, IModelElement
    {
        ...
        public virtual IUsageScenario UsageScenario_SenarioBehaviour
        {
            ...
            set
            {
                if ((this._usageScenario_SenarioBehaviour != value))
                {
                    ...
                    this.OnPropertyChanging("UsageScenario_SenarioBehaviour", e);
        ...
        public virtual IBranchTransition BranchTransition_ScenarioBehaviour
        {
            ...
            set
            {
                if ((this._branchTransition_ScenarioBehaviour != value))
                {
                    ...
                    this.OnPropertyChanging("BranchTransition_ScenarioBehaviour", e);
        ...
        public virtual ILoop Loop_ScenarioBehaviour
        {
            ...
            set
            {
                if ((this._loop_ScenarioBehaviour != value))
                {
                    ...
                    this.OnPropertyChanging("Loop_ScenarioBehaviour", e);
        ...
        public new static IClass ClassInstance
        {
            get
            {
                ...
                {
                    _classInstance = ((IClass)(MetaRepository.Instance.Resolve("http://github.com/ghmanager/DeepPCM/1.0#//usagemodel//ScenarioBehaviour/")));
                }
        ...
        /// </summary>
        public event System.EventHandler<ValueChangedEventArgs> UsageScenario_SenarioBehaviourChanging;
        
        /// <summary>
        /// Gets fired when the UsageScenario_SenarioBehaviour property changed its value
        /// </summary>
        public event System.EventHandler<ValueChangedEventArgs> UsageScenario_SenarioBehaviourChanged;
        
        /// <summary>
        /// Gets fired before the BranchTransition_ScenarioBehaviour property changes its value
        /// </summary>
        public event System.EventHandler<ValueChangedEventArgs> BranchTransition_ScenarioBehaviourChanging;
        
        /// <summary>
        /// Gets fired when the BranchTransition_ScenarioBehaviour property changed its value
        /// </summary>
        public event System.EventHandler<ValueChangedEventArgs> BranchTransition_ScenarioBehaviourChanged;
        
        /// <summary>
        /// Gets fired before the Loop_ScenarioBehaviour property changes its value
        /// </summary>
        public event System.EventHandler<ValueChangedEventArgs> Loop_ScenarioBehaviourChanging;
        
        /// <summary>
        /// Gets fired when the Loop_ScenarioBehaviour property changed its value
        /// </summary>
        public event System.EventHandler<ValueChangedEventArgs> Loop_ScenarioBehaviourChanged;
        ...
        private void Exactlyonestart(object diagnostics, object context)
        {
            if ((diagnostics != null))
            {
        ...
        /// <param name="diagnostics"></param>
        /// <param name="context"></param>
        private void Exactlyonestop(object diagnostics, object context)
        {
            if ((diagnostics != null))
            {
                throw new ArgumentNullException("diagnostics");
        ...
        /// <param name="diagnostics"></param>
        /// <param name="context"></param>
        private void EachuseractionexceptStartandStopmusthaveapredecessorandsuccessor(object diagnostics, object context)
        {
            if ((diagnostics != null))
            {
                throw new ArgumentNullException("diagnostics");
        ...
        {
            System.EventHandler<ValueChangedEventArgs> handler = this.UsageScenario_SenarioBehaviourChanging;
            if ((handler != null))
            {
        ...
        {
            System.EventHandler<ValueChangedEventArgs> handler = this.UsageScenario_SenarioBehaviourChanged;
            if ((handler != null))
            {
                handler.Invoke(this, eventArgs);
            }
        ...
        private void OnResetUsageScenario_SenarioBehaviour(object sender, System.EventArgs eventArgs)
        {
        ...
        {
            System.EventHandler<ValueChangedEventArgs> handler = this.BranchTransition_ScenarioBehaviourChanging;
            if ((handler != null))
            {
                handler.Invoke(this, eventArgs);
            }
        ...
        {
            System.EventHandler<ValueChangedEventArgs> handler = this.BranchTransition_ScenarioBehaviourChanged;
            if ((handler != null))
            {
                handler.Invoke(this, eventArgs);
            }
        ...
        /// <param name="sender">The object that sent this reset request</param>
        /// <param name="eventArgs">The event data for the reset event</param>
        private void OnResetBranchTransition_ScenarioBehaviour(object sender, System.EventArgs eventArgs)
        {
        ...
        {
            System.EventHandler<ValueChangedEventArgs> handler = this.Loop_ScenarioBehaviourChanging;
            if ((handler != null))
            {
                handler.Invoke(this, eventArgs);
            }
        ...
        {
            System.EventHandler<ValueChangedEventArgs> handler = this.Loop_ScenarioBehaviourChanged;
            if ((handler != null))
            {
                handler.Invoke(this, eventArgs);
            }
        ...
        /// <param name="sender">The object that sent this reset request</param>
        /// <param name="eventArgs">The event data for the reset event</param>
        private void OnResetLoop_ScenarioBehaviour(object sender, System.EventArgs eventArgs)
        {
        ...
        private void Actions_ScenarioBehaviourCollectionChanging(object sender, NMF.Collections.ObjectModel.NotifyCollectionChangingEventArgs e)
        {
            this.OnCollectionChanging("Actions_ScenarioBehaviour", e);
        }
