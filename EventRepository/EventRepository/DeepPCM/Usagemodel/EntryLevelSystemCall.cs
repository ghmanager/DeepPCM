...
namespace Metamodel.DeepPCM.Usagemodel
{
    ...
    [ModelRepresentationClassAttribute("http://github.com/ghmanager/DeepPCM/1.0#//usagemodel//EntryLevelSystemCall/")]
    ...
    public class EntryLevelSystemCall : AbstractUserAction, IEntryLevelSystemCall, IModelElement
    {
        ...
        public virtual IOperationInterface ProvidedInterface_EntryLevelSystemCall
        {
            ...
            set
            {
                if ((this._providedInterface_EntryLevelSystemCall != value))
                {
                    ...
                    ValueChangedEventArgs e = new ValueChangedEventArgs(old, value);
                    this.OnProvidedInterface_EntryLevelSystemCallChanging(e);
                    this.OnPropertyChanging("ProvidedInterface_EntryLevelSystemCall", e);
        ...
        public virtual IOperationSignature OperationSignature__EntryLevelSystemCall
        {
            ...
            set
            {
                if ((this._operationSignature__EntryLevelSystemCall != value))
                {
                    ...
                    this.OnPropertyChanging("OperationSignature__EntryLevelSystemCall", e);
        ...
        public new static IClass ClassInstance
        {
            get
            {
                ...
                {
                    _classInstance = ((IClass)(MetaRepository.Instance.Resolve("http://github.com/ghmanager/DeepPCM/1.0#//usagemodel//EntryLevelSystemCall/")));
                }
        ...
        /// </summary>
        public event System.EventHandler<ValueChangedEventArgs> ProvidedInterface_EntryLevelSystemCallChanging;
        
        /// <summary>
        /// Gets fired when the ProvidedInterface_EntryLevelSystemCall property changed its value
        /// </summary>
        public event System.EventHandler<ValueChangedEventArgs> ProvidedInterface_EntryLevelSystemCallChanged;
        
        /// <summary>
        /// Gets fired before the OperationSignature__EntryLevelSystemCall property changes its value
        /// </summary>
        public event System.EventHandler<ValueChangedEventArgs> OperationSignature__EntryLevelSystemCallChanging;
        
        /// <summary>
        /// Gets fired when the OperationSignature__EntryLevelSystemCall property changed its value
        /// </summary>
        public event System.EventHandler<ValueChangedEventArgs> OperationSignature__EntryLevelSystemCallChanged;
        ...
        private void EntryLevelSystemCallMustReferenceProvidedInterfaceOfASystem(object diagnostics, object context)
        {
            if ((diagnostics != null))
            {
        ...
        /// <param name="diagnostics"></param>
        /// <param name="context"></param>
        private void EntryLevelSystemCallSignatureMustMatchItsProvidedInterface(object diagnostics, object context)
        {
            if ((diagnostics != null))
            {
                throw new ArgumentNullException("diagnostics");
        ...
        /// <summary>
        /// Raises the ProvidedInterface_EntryLevelSystemCallChanging event
        /// </summary>
        /// <param name="eventArgs">The event data</param>
        protected virtual void OnProvidedInterface_EntryLevelSystemCallChanging(ValueChangedEventArgs eventArgs)
        {
            System.EventHandler<ValueChangedEventArgs> handler = this.ProvidedInterface_EntryLevelSystemCallChanging;
            if ((handler != null))
            {
                handler.Invoke(this, eventArgs);
            }
        ...
        {
            System.EventHandler<ValueChangedEventArgs> handler = this.ProvidedInterface_EntryLevelSystemCallChanged;
            if ((handler != null))
            {
                handler.Invoke(this, eventArgs);
            }
        ...
        private void OnResetProvidedInterface_EntryLevelSystemCall(object sender, System.EventArgs eventArgs)
        {
        ...
        {
            System.EventHandler<ValueChangedEventArgs> handler = this.OperationSignature__EntryLevelSystemCallChanging;
            if ((handler != null))
            {
                handler.Invoke(this, eventArgs);
            }
        ...
        {
            System.EventHandler<ValueChangedEventArgs> handler = this.OperationSignature__EntryLevelSystemCallChanged;
            if ((handler != null))
            {
                handler.Invoke(this, eventArgs);
            }
        ...
        /// <param name="sender">The object that sent this reset request</param>
        /// <param name="eventArgs">The event data for the reset event</param>
        private void OnResetOperationSignature__EntryLevelSystemCall(object sender, System.EventArgs eventArgs)
        {
        ...
        private void OutputParameterUsages_EntryLevelSystemCallCollectionChanging(object sender, NMF.Collections.ObjectModel.NotifyCollectionChangingEventArgs e)
        {
            this.OnCollectionChanging("OutputParameterUsages_EntryLevelSystemCall", e);
        }
        ...
        /// <param name="sender">The collection that raised the change</param>
        /// <param name="e">The original event data</param>
        private void InputParameterUsages_EntryLevelSystemCallCollectionChanging(object sender, NMF.Collections.ObjectModel.NotifyCollectionChangingEventArgs e)
        {
            this.OnCollectionChanging("InputParameterUsages_EntryLevelSystemCall", e);
        }
