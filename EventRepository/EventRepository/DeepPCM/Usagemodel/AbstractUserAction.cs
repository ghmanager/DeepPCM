...
namespace Metamodel.DeepPCM.Usagemodel
{
    ...
    [ModelRepresentationClassAttribute("http://github.com/ghmanager/DeepPCM/1.0#//usagemodel//AbstractUserAction/")]
    [DebuggerDisplayAttribute("AbstractUserAction {Id}")]
    public abstract class AbstractUserAction : Metamodel.DeepPCM.Core.Entity.Entity, IAbstractUserAction, IModelElement
    {
        ...
        public virtual IAbstractUserAction Successor
        {
            ...
            set
            {
                if ((this._successor != value))
                {
                    ...
                    this.OnPropertyChanging("Successor", e);
        ...
        public virtual IAbstractUserAction Predecessor
        {
            ...
            set
            {
                if ((this._predecessor != value))
                {
                    ...
                    this.OnPropertyChanging("Predecessor", e);
        ...
        public new static IClass ClassInstance
        {
            get
            {
                ...
                {
                    _classInstance = ((IClass)(MetaRepository.Instance.Resolve("http://github.com/ghmanager/DeepPCM/1.0#//usagemodel//AbstractUserAction/")));
                }
        ...
        /// </summary>
        public event System.EventHandler<ValueChangedEventArgs> SuccessorChanging;
        
        /// <summary>
        /// Gets fired when the Successor property changed its value
        /// </summary>
        public event System.EventHandler<ValueChangedEventArgs> SuccessorChanged;
        
        /// <summary>
        /// Gets fired before the Predecessor property changes its value
        /// </summary>
        public event System.EventHandler<ValueChangedEventArgs> PredecessorChanging;
        
        /// <summary>
        /// Gets fired when the Predecessor property changed its value
        /// </summary>
        public event System.EventHandler<ValueChangedEventArgs> PredecessorChanged;
        
        /// <summary>
        /// Gets fired before the ScenarioBehaviour_AbstractUserAction property changes its value
        /// </summary>
        public event System.EventHandler<ValueChangedEventArgs> ScenarioBehaviour_AbstractUserActionChanging;
        
        /// <summary>
        /// Gets fired when the ScenarioBehaviour_AbstractUserAction property changed its value
        /// </summary>
        public event System.EventHandler<ValueChangedEventArgs> ScenarioBehaviour_AbstractUserActionChanged;
        ...
        {
            System.EventHandler<ValueChangedEventArgs> handler = this.SuccessorChanging;
            if ((handler != null))
            {
        ...
        {
            System.EventHandler<ValueChangedEventArgs> handler = this.SuccessorChanged;
            if ((handler != null))
            {
                handler.Invoke(this, eventArgs);
            }
        ...
        private void OnResetSuccessor(object sender, System.EventArgs eventArgs)
        {
            this.Successor = null;
        }
        ...
        {
            System.EventHandler<ValueChangedEventArgs> handler = this.PredecessorChanging;
            if ((handler != null))
            {
                handler.Invoke(this, eventArgs);
            }
        ...
        {
            System.EventHandler<ValueChangedEventArgs> handler = this.PredecessorChanged;
            if ((handler != null))
            {
                handler.Invoke(this, eventArgs);
            }
        ...
        /// <param name="sender">The object that sent this reset request</param>
        /// <param name="eventArgs">The event data for the reset event</param>
        private void OnResetPredecessor(object sender, System.EventArgs eventArgs)
        {
        ...
        {
            System.EventHandler<ValueChangedEventArgs> handler = this.ScenarioBehaviour_AbstractUserActionChanging;
            if ((handler != null))
            {
                handler.Invoke(this, eventArgs);
            }
        ...
        protected override void OnParentChanging(IModelElement newParent, IModelElement oldParent)
        {
            ...
            this.OnPropertyChanging("ScenarioBehaviour_AbstractUserAction");
        }
        ...
        {
            System.EventHandler<ValueChangedEventArgs> handler = this.ScenarioBehaviour_AbstractUserActionChanged;
            if ((handler != null))
            {
                handler.Invoke(this, eventArgs);
            }
