...
namespace Metamodel.DeepPCM.Usagemodel
{
    ...
    [ModelRepresentationClassAttribute("http://github.com/ghmanager/DeepPCM/1.0#//usagemodel//Workload/")]
    public abstract class Workload : ModelElement, IWorkload, IModelElement
    {
        ...
        public virtual IUsageScenario UsageScenario_Workload
        {
            get
            {
        ...
        public new static IClass ClassInstance
        {
            get
            {
                ...
                {
                    _classInstance = ((IClass)(MetaRepository.Instance.Resolve("http://github.com/ghmanager/DeepPCM/1.0#//usagemodel//Workload/")));
                }
        ...
        /// </summary>
        public event System.EventHandler<ValueChangedEventArgs> UsageScenario_WorkloadChanging;
        
        /// <summary>
        /// Gets fired when the UsageScenario_Workload property changed its value
        /// </summary>
        public event System.EventHandler<ValueChangedEventArgs> UsageScenario_WorkloadChanged;
        ...
        {
            System.EventHandler<ValueChangedEventArgs> handler = this.UsageScenario_WorkloadChanging;
            if ((handler != null))
            {
        ...
        protected override void OnParentChanging(IModelElement newParent, IModelElement oldParent)
        {
            ...
            this.OnPropertyChanging("UsageScenario_Workload");
        }
        ...
        {
            System.EventHandler<ValueChangedEventArgs> handler = this.UsageScenario_WorkloadChanged;
            if ((handler != null))
            {
                handler.Invoke(this, eventArgs);
            }
        ...
        protected override void OnParentChanged(IModelElement newParent, IModelElement oldParent)
        {
            ...
            this.OnPropertyChanged("UsageScenario_Workload", e);
        }
        ...
        private sealed class UsageScenario_WorkloadProxy : ModelPropertyChange<IWorkload, IUsageScenario>
        {
            ...
            {
                this.ModelElement.UsageScenario_WorkloadChanged += handler;
            }
