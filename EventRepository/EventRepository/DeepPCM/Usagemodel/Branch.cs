...
namespace Metamodel.DeepPCM.Usagemodel
{
    ...
    [ModelRepresentationClassAttribute("http://github.com/ghmanager/DeepPCM/1.0#//usagemodel//Branch/")]
    ...
    public class Branch : AbstractUserAction, IBranch, IModelElement
    {
        ...
        public new static IClass ClassInstance
        {
            get
            {
                ...
                {
                    _classInstance = ((IClass)(MetaRepository.Instance.Resolve("http://github.com/ghmanager/DeepPCM/1.0#//usagemodel//Branch/")));
                }
        ...
        private void AllBranchProbabilitiesMustSumUpTo1(object diagnostics, object context)
        {
            if ((diagnostics != null))
            {
        ...
        private void BranchTransitions_BranchCollectionChanging(object sender, NMF.Collections.ObjectModel.NotifyCollectionChangingEventArgs e)
        {
            this.OnCollectionChanging("BranchTransitions_Branch", e);
        }
