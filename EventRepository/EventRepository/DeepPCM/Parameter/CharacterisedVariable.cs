...
namespace Metamodel.DeepPCM.Parameter
{
    ...
    [ModelRepresentationClassAttribute("http://github.com/ghmanager/DeepPCM/1.0#//parameter//CharacterisedVariable/")]
    public class CharacterisedVariable : Variable, ICharacterisedVariable, IModelElement
    {
        ...
        public virtual VariableCharacterisationType CharacterisationType
        {
            ...
            set
            {
                if ((this._characterisationType != value))
                {
                    ...
                    this.OnPropertyChanging("CharacterisationType", e);
        ...
        public new static IClass ClassInstance
        {
            get
            {
                ...
                {
                    _classInstance = ((IClass)(MetaRepository.Instance.Resolve("http://github.com/ghmanager/DeepPCM/1.0#//parameter//CharacterisedVariable/")));
                }
        ...
        /// </summary>
        public event System.EventHandler<ValueChangedEventArgs> CharacterisationTypeChanging;
        
        /// <summary>
        /// Gets fired when the CharacterisationType property changed its value
        /// </summary>
        public event System.EventHandler<ValueChangedEventArgs> CharacterisationTypeChanged;
        ...
        {
            System.EventHandler<ValueChangedEventArgs> handler = this.CharacterisationTypeChanging;
            if ((handler != null))
            {
        ...
        {
            System.EventHandler<ValueChangedEventArgs> handler = this.CharacterisationTypeChanged;
            if ((handler != null))
            {
                handler.Invoke(this, eventArgs);
            }
