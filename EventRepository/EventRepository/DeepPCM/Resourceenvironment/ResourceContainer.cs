...
namespace Metamodel.DeepPCM.Resourceenvironment
{
    ...
    [ModelRepresentationClassAttribute("http://github.com/ghmanager/DeepPCM/1.0#//resourceenvironment//ResourceContainer/" +
        "")]
    [DebuggerDisplayAttribute("ResourceContainer {Id}")]
    public class ResourceContainer : Metamodel.DeepPCM.Core.Entity.Entity, IResourceContainer, IModelElement
    {
        ...
        public virtual IResourceEnvironment ResourceEnvironment_ResourceContainer
        {
            ...
            set
            {
                if ((this._resourceEnvironment_ResourceContainer != value))
                {
                    ...
                    this.OnPropertyChanging("ResourceEnvironment_ResourceContainer", e);
        ...
        public virtual IResourceContainer ParentResourceContainer__ResourceContainer
        {
            ...
            set
            {
                if ((this._parentResourceContainer__ResourceContainer != value))
                {
                    ...
                    this.OnPropertyChanging("ParentResourceContainer__ResourceContainer", e);
        ...
        public new static IClass ClassInstance
        {
            get
            {
                ...
                {
                    _classInstance = ((IClass)(MetaRepository.Instance.Resolve("http://github.com/ghmanager/DeepPCM/1.0#//resourceenvironment//ResourceContainer/" +
                            "")));
                }
        ...
        /// </summary>
        public event System.EventHandler<ValueChangedEventArgs> ResourceEnvironment_ResourceContainerChanging;
        
        /// <summary>
        /// Gets fired when the ResourceEnvironment_ResourceContainer property changed its value
        /// </summary>
        public event System.EventHandler<ValueChangedEventArgs> ResourceEnvironment_ResourceContainerChanged;
        
        /// <summary>
        /// Gets fired before the ParentResourceContainer__ResourceContainer property changes its value
        /// </summary>
        public event System.EventHandler<ValueChangedEventArgs> ParentResourceContainer__ResourceContainerChanging;
        
        /// <summary>
        /// Gets fired when the ParentResourceContainer__ResourceContainer property changed its value
        /// </summary>
        public event System.EventHandler<ValueChangedEventArgs> ParentResourceContainer__ResourceContainerChanged;
        ...
        private void ActiveResourceSpecifications_ResourceContainerCollectionChanging(object sender, NMF.Collections.ObjectModel.NotifyCollectionChangingEventArgs e)
        {
            this.OnCollectionChanging("ActiveResourceSpecifications_ResourceContainer", e);
        }
        ...
        {
            System.EventHandler<ValueChangedEventArgs> handler = this.ResourceEnvironment_ResourceContainerChanging;
            if ((handler != null))
            {
        ...
        {
            System.EventHandler<ValueChangedEventArgs> handler = this.ResourceEnvironment_ResourceContainerChanged;
            if ((handler != null))
            {
                handler.Invoke(this, eventArgs);
            }
        ...
        private void OnResetResourceEnvironment_ResourceContainer(object sender, System.EventArgs eventArgs)
        {
        ...
        /// <param name="sender">The collection that raised the change</param>
        /// <param name="e">The original event data</param>
        private void NestedResourceContainers__ResourceContainerCollectionChanging(object sender, NMF.Collections.ObjectModel.NotifyCollectionChangingEventArgs e)
        {
            this.OnCollectionChanging("NestedResourceContainers__ResourceContainer", e);
        }
        ...
        {
            System.EventHandler<ValueChangedEventArgs> handler = this.ParentResourceContainer__ResourceContainerChanging;
            if ((handler != null))
            {
                handler.Invoke(this, eventArgs);
            }
        ...
        {
            System.EventHandler<ValueChangedEventArgs> handler = this.ParentResourceContainer__ResourceContainerChanged;
            if ((handler != null))
            {
                handler.Invoke(this, eventArgs);
            }
        ...
        /// <param name="sender">The object that sent this reset request</param>
        /// <param name="eventArgs">The event data for the reset event</param>
        private void OnResetParentResourceContainer__ResourceContainer(object sender, System.EventArgs eventArgs)
        {
