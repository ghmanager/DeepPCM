...
namespace Metamodel.DeepPCM.Resourceenvironment
{
    ...
    [ModelRepresentationClassAttribute("http://github.com/ghmanager/DeepPCM/1.0#//resourceenvironment//ResourceEnvironmen" +
        "t/")]
    public class ResourceEnvironment : NamedElement, IResourceEnvironment, IModelElement
    {
        ...
        public new static IClass ClassInstance
        {
            get
            {
                ...
                {
                    _classInstance = ((IClass)(MetaRepository.Instance.Resolve("http://github.com/ghmanager/DeepPCM/1.0#//resourceenvironment//ResourceEnvironmen" +
                            "t/")));
                }
        ...
        private void LinkingResources__ResourceEnvironmentCollectionChanging(object sender, NMF.Collections.ObjectModel.NotifyCollectionChangingEventArgs e)
        {
            this.OnCollectionChanging("LinkingResources__ResourceEnvironment", e);
        }
        ...
        /// <param name="sender">The collection that raised the change</param>
        /// <param name="e">The original event data</param>
        private void ResourceContainer_ResourceEnvironmentCollectionChanging(object sender, NMF.Collections.ObjectModel.NotifyCollectionChangingEventArgs e)
        {
            this.OnCollectionChanging("ResourceContainer_ResourceEnvironment", e);
        }
