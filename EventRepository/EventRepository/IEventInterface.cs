...
namespace Metamodel.Repo
{
    ...
    /// <summary>
    /// The public interface for EventInterface
    /// </summary>
    [DefaultImplementationTypeAttribute(typeof(EventInterface))]
    [XmlDefaultImplementationTypeAttribute(typeof(EventInterface))]
    public interface IEventInterface : IModelElement, IAssemblyContext
    {
    }
}
