...
namespace Metamodel.Repo
{
    ...
    /// <summary>
    /// The public interface for EventGroupChannel
    /// </summary>
    [DefaultImplementationTypeAttribute(typeof(EventGroupChannel))]
    [XmlDefaultImplementationTypeAttribute(typeof(EventGroupChannel))]
    public interface IEventGroupChannel : IModelElement, IEventPublisher
    {
    }
}
